...
class SitePlaylist(
    ...
    override fun compareTo(other: SitePlaylist): Int = compareValuesBy(this, other, { !it.isFavorites }, { it.sortOrder }, { it.id })

    override fun toDTO(): SitePlaylistDto =
        SitePlaylistDto(
            id = id,
            ownerId = ownerId,
            name = name,
