<template>
  <transition name="modal-fade">
    <div class="scm-modal-backdrop">
      <div class="scm-area">
        <div class="scm-area-modal-header">Smart Copy</div>
          ...
          <div class="scm-root-wrapper">
            <div class="scm-smartcopy-row">
              ...
              <div class="scm-row-input">
                <button
                  class="scm-group-button"
                  :class="smartCopySongVersionButtonClass('ALL')"
                  type="button"
                  value="ALL"
                  @click="setSmartCopySongVersion('ALL')"
                >
                  Все версии
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopySongVersionButtonClass('KARAOKE')"
                  type="button"
                  value="KARAOKE"
                  @click="setSmartCopySongVersion('KARAOKE')"
                >
                  KARAOKE
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopySongVersionButtonClass('LYRICS')"
                  type="button"
                  value="LYRICS"
                  @click="setSmartCopySongVersion('LYRICS')"
                >
                  LYRICS
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopySongVersionButtonClass('CHORDS')"
                  type="button"
                  value="CHORDS"
                  @click="setSmartCopySongVersion('CHORDS')"
                >
                  CHORDS
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopySongVersionButtonClass('TABS')"
                  type="button"
                  value="TABS"
                  @click="setSmartCopySongVersion('TABS')"
                >
                  TABS
                </button>
              </div>
            ...
            <div class="scm-smartcopy-row">
              ...
              <div class="scm-row-input">
                <button
                  class="scm-group-button"
                  :class="smartCopySongResolutionButtonClass('1080p')"
                  type="button"
                  value="1080p"
                  @click="setSmartCopySongResolution('1080p')"
                >
                  1080p 60fps
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopySongResolutionButtonClass('720p')"
                  type="button"
                  value="720p"
                  @click="setSmartCopySongResolution('720p')"
                >
                  720p 30fps
                </button>
              </div>
            ...
            <div class="scm-smartcopy-row">
              ...
              <div class="scm-row-input">
                <button
                  class="scm-group-button"
                  :class="smartCopyCreateSubfoldersAuthorsButtonClass(false)"
                  type="button"
                  value="false"
                  @click="setSmartCopyCreateSubfoldersAuthors(false)"
                >
                  Не создавать
                </button>
                <button
                  class="scm-group-button"
                  :class="smartCopyCreateSubfoldersAuthorsButtonClass(true)"
                  type="button"
                  value="true"
                  @click="setSmartCopyCreateSubfoldersAuthors(true)"
                >
                  Создавать для авторов
                </button>
              </div>
            </div>
            ...
            <div class="scm-smartcopy-row">
              ...
              <button
                :disabled="!smartCopyRenameTemplate"
                class="scm-button-clear-field"
                @click.left="smartCopyRenameTemplate = ''"
                v-text="'X'"
              />
            </div>
            ...
            <div class="scm-smartcopy-row">
              ...
              <div class="scm-row-input">
                <input
                  v-model="smartCopyPath"
                  class="scm-input-field"
                  @dblclick="isFileExplorerVisible = true"
                />
              </div>
              <button
                :disabled="!smartCopyPath"
                class="scm-button-clear-field"
                @click.left="smartCopyPath = ''"
                v-text="'X'"
              />
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    smartCopySongResolutionButtonClass(smartCopySongResolution) {
      return smartCopySongResolution === this.smartCopySongResolution
        ? 'scm-group-button-active'
        : ''
    },
    smartCopyCreateSubfoldersAuthorsButtonClass(smartCopyCreateSubfoldersAuthors) {
      return smartCopyCreateSubfoldersAuthors === this.smartCopyCreateSubfoldersAuthors
        ? 'scm-group-button-active'
        : ''
    },
    ...
    doSmartCopy(result) {
      ...
      this.$store.dispatch('setSmartCopySongVersion', {
        smartCopySongVersion: this.smartCopySongVersion,
      })
      this.$store.dispatch('setSmartCopySongResolution', {
        smartCopySongResolution: this.smartCopySongResolution,
      })
      this.$store.dispatch('setSmartCopyCreateSubfoldersAuthors', {
        smartCopyCreateSubfoldersAuthors: this.smartCopyCreateSubfoldersAuthors,
      })
      this.$store.dispatch('setSmartCopyRenameTemplate', {
        smartCopyRenameTemplate: this.smartCopyRenameTemplate,
      })
      ...
      if (this.smartCopySongResolution)
        params.smartCopySongResolution = this.smartCopySongResolution
      if (this.smartCopyCreateSubfoldersAuthors)
        params.smartCopyCreateSubfoldersAuthors = this.smartCopyCreateSubfoldersAuthors
      if (this.smartCopyRenameTemplate)
        params.smartCopyRenameTemplate = this.smartCopyRenameTemplate
