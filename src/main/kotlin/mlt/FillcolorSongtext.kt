...
fun getMltFillColorSongtextEvenProducer(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillColorSongtextOddProducer(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextEvenFilePlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextEvenTrackPlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextEvenTractor(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextOddFilePlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextOddTrackPlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFillSongtextOddTractor(param: Map<String, Any?>, type:ProducerType = ProducerType.FILLCOLORSONGTEXT, voiceId: Int = 0): MltNode {
