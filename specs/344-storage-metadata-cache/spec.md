...
- **Title**: Кеширование информации из хранилища (storage metadata cache).
...
| 4. **Add comment с отчётом** | `bash tools/tracker.sh add-comment 69 --file specs/344-storage-metadata-cache/report.md` | После merge. Файл `report.md` — REQUIRED. | Agent |
