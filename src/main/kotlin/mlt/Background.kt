...
fun getMltBackgroundProducer(param: Map<String, Any?>, type:ProducerType = ProducerType.BACKGROUND, groupId: Int = 0): MltNode {
...
fun getMltBackgroundFilePlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.BACKGROUND, groupId: Int = 0): MltNode {
    ...
    val mlt = MltNode(
        ...
        body = mutableListOf(
            MltNode(name = "entry", fields = mutableMapOf(
                ...
                MltNode(name = "filter",
                    fields = mutableMapOf(Pair("id","filter_${type.text}${groupId}_gamma")),
                    body = mutableListOf(
...
fun getMltBackgroundTrackPlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.BACKGROUND, groupId: Int = 0): MltNode {
...
fun getMltBackgroundTractor(param: Map<String, Any?>, type:ProducerType = ProducerType.BACKGROUND, groupId: Int = 0): MltNode {
