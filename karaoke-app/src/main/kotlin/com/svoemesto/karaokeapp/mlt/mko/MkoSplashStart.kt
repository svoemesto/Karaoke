...
data class MkoSplashStart(
    ...
    private val toneBpmDescriptionText =
        when (songVersion) {
...
//        val chordDescriptionTextH =  (getTextWidthHeightPx(chordDescriptionText, chordDescriptionTextFontMlt.font).second).toLong()
        ...
        val chordDescriptionTextY =
            if (chordDescriptionText !=
                ""
            ) {
                (commentTextY - getTextWidthHeightPx("0", chordDescriptionTextFontMlt.font).second).toLong()
            } else {
                commentTextY
            }
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "$authorPictureX"), Pair("y", "$authorPictureY")),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "$albumPictureX"), Pair("y", "$albumPictureY")),
                            body = mutableListOf(MltNode(name = "transform", body = "$pictureScaleCoeff,0,0,0,$pictureScaleCoeff,0,0,0,1")),
                        ),
...
//                        MltNode(name = "position", fields = mutableMapOf(Pair("x","${multiLine.centerX + padding}"),Pair("y","-50")),
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        Pair("x", "${multiLine.centerX + padding}"),
                                        Pair("y", "${multiLine.topY + (picAreaH - padding)}"),
                                    ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "$songVersionTextX"), Pair("y", "$songVersionTextY")),
                            body = mutableListOf(MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1")),
                        ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "$chordDescriptionTextX"), Pair("y", "$chordDescriptionTextY")),
                                body = mutableListOf(MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1")),
                            ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "$commentTextX"), Pair("y", "$commentTextY")),
                            body = mutableListOf(MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1")),
                        ),
