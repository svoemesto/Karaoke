...
fun getMltHorizonProducer(param: Map<String, Any?>): MltNode {

    val mlt = MltNode(
        name = "producer",
        fields = mutableMapOf(
            Pair("id","producer_horizon"),
        ...
        body = mutableListOf(
            ...
            MltNode(name = "property", fields = mutableMapOf(Pair("name","kdenlive:clipname")), body = "HORIZON"),
            MltNode(name = "property", fields = mutableMapOf(Pair("name","xmldata")), body = param["HORIZON_XML_DATA"]),
            ...
            MltNode(name = "property", fields = mutableMapOf(Pair("name","kdenlive:id")), body = param["HORIZON_ID"]),
...
fun getMltHorizonFilePlaylist(param: Map<String, Any?>): MltNode {

    val mlt = MltNode(
        name = "playlist",
        fields = mutableMapOf(
            Pair("id","playlist_horizon_file")
        ),
        body = mutableListOf(
            MltNode(name = "entry", fields = mutableMapOf(
                Pair("producer","producer_horizon"),
                Pair("in",param["SONG_START_TIMECODE"].toString()),
                Pair("out",param["SONG_END_TIMECODE"].toString()),
            ), body = mutableListOf(
                MltNode(name = "property", fields = mutableMapOf(Pair("name","kdenlive:id")), body = param["HORIZON_ID"]),
                MltNode(name = "filter",
                    fields = mutableMapOf(Pair("id","filter_horizon_qtblend")),
                    body = mutableListOf(
...
fun getMltHorizonTrackPlaylist(param: Map<String, Any?>): MltNode {

    val mlt = MltNode(
        name = "playlist",
        fields = mutableMapOf(
            Pair("id","playlist_horizon_track")
        )
    )
...
fun getMltHorizonTractor(param: Map<String, Any?>): MltNode {

    val mlt = MltNode(
        name = "tractor",
        fields = mutableMapOf(
            Pair("id","tractor_horizon"),
            Pair("in",param["SONG_START_TIMECODE"].toString()),
            Pair("out",param["SONG_END_TIMECODE"].toString())
        ),
        body = mutableListOf(
            ...
            MltNode(name = "property", fields = mutableMapOf(Pair("name","kdenlive:track_name")), body = "HORIZON"),
            ...
            MltNode(name = "track",
                fields = mutableMapOf(
                    Pair("hide",param["HIDE_TRACTOR_HORIZON"].toString()),
                    Pair("producer","playlist_horizon_file"))),
            MltNode(name = "track",
                fields = mutableMapOf(
                    Pair("hide",param["HIDE_TRACTOR_HORIZON"].toString()),
                    Pair("producer","playlist_horizon_track"))),
