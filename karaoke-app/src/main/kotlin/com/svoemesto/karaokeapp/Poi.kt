...
//                chordsDelay = song.settings.idDzenChordsBt ?: ""
            ...
            if ("$lyricsNormal$karaokeNormal" != "") {
                ...
                val lyricsNormalLink = if (lyricsNormal == "") "" else "Lyrics: " + URL_PREFIX_DZEN_PLAY.replace("{REPLACE}", lyricsNormal) +"\n"
//                val lyricsDelayLink = if (lyricsDelay == "") "" else "Lyrics with delay: " + URL_PREFIX_DZEN_PLAY.replace("{REPLACE}", lyricsDelay) +"\n"
                val karaokeNormalLink = if (karaokeNormal == "") "" else "Karaoke: " +  URL_PREFIX_DZEN_PLAY.replace("{REPLACE}", karaokeNormal) +"\n"
//                val karaokeDelayLink = if (karaokeDelay == "") "" else "Karaoke with delay: " + URL_PREFIX_DZEN_PLAY.replace("{REPLACE}", karaokeDelay) +"\n"
                val chordsNormalLink = if (chordsNormal == "") "" else "Chords: " + URL_PREFIX_DZEN_PLAY.replace("{REPLACE}", chordsNormal) +"\n"
