...
export default {
  ...
  computed: {
    ...
    label() {
      return this.$store.getters.getProcessFieldParams(this.name).label;
    },
    labelPadding() {
      return this.$store.getters.getProcessFieldParams(this.name).labelPadding;
    },
    fontSize() {
      return this.$store.getters.getProcessFieldParams(this.name).labelFontSize;
    },
    fontSizeFilter() {
      return this.$store.getters.getProcessFieldParams(this.name).filterFontSize;
    },
    widthFilter() {
      return this.$store.getters.getProcessFieldParams(this.name).filterWidth+'px';
    },
    styleWrapperTd() {
      return {
        alignContent: 'center',
