...
val listKaraokeProperties = listOf(
    ...
    KaraokeProperty(key = "stemJobsWebInternalUrl", defaultValue = "", description = "Базовый URL karaoke-web (прод) для internal-эндпоинтов «Создать минусовку» (пусто = поллер выключен, см. StemJobPollScheduler)"),
    KaraokeProperty(key = "stemJobsInternalSecret", defaultValue = "", description = "Общий секрет заголовка X-Internal-Secret с karaoke-web (STEMJOBS_INTERNAL_SECRET) для «Создать минусовку»"),
    ...
    KaraokeProperty(key = "sync_dictionaries_push_insert_allowed", defaultValue = false, description = "Синхронизация: Словари — push, Добавление"),
    KaraokeProperty(key = "sync_dictionaries_push_update_allowed", defaultValue = false, description = "Синхронизация: Словари — push, Изменение"),
    KaraokeProperty(key = "sync_dictionaries_push_delete_allowed", defaultValue = false, description = "Синхронизация: Словари — push, Удаление"),
    KaraokeProperty(key = "sync_dictionaries_push_move_allowed", defaultValue = false, description = "Синхронизация: Словари — push, Перемещение"),
    KaraokeProperty(key = "sync_dictionaries_pull_insert_allowed", defaultValue = false, description = "Синхронизация: Словари — pull, Добавление"),
    ...
    KaraokeProperty(key = "sync_subscriptions_push_insert_allowed", defaultValue = false, description = "Синхронизация: Подписки — push, Добавление"),
    KaraokeProperty(key = "sync_subscriptions_push_update_allowed", defaultValue = false, description = "Синхронизация: Подписки — push, Изменение"),
    KaraokeProperty(key = "sync_subscriptions_push_delete_allowed", defaultValue = false, description = "Синхронизация: Подписки — push, Удаление"),
    KaraokeProperty(key = "sync_subscriptions_push_move_allowed", defaultValue = false, description = "Синхронизация: Подписки — push, Перемещение"),
    KaraokeProperty(key = "sync_subscriptions_pull_insert_allowed", defaultValue = true, description = "Синхронизация: Подписки — pull, Добавление"),
