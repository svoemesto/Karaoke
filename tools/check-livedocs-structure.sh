...
frontmatter_total=0
frontmatter_fail=0
for f in $(find livedocs -name '*.md' -not -name 'README.md' -not -name 'INDEX.md' -not -name 'INDEX_CARD.md' -not -name 'STATS.md' -not -path '*/templates/*' -not -path '*/decisions/*' -not -path '*/runbooks/*' -not -path '*/commands/*' -not -path '*/CHANGELOG.md'); do
