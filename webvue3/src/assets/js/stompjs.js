...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports'], t)
      : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).StompJs = {}))
})(this, function (e) {
  'use strict'
  const t = '\n',
    s = '\0'
  ...
  ;((e.StompSocketState = void 0),
    ...
    ((c = e.ActivationState = e.ActivationState || (e.ActivationState = {}))[(c.ACTIVE = 0)] =
      'ACTIVE'),
  ...
  class a {
    ...
    _transmit(e) {
      ...
      let a = r.serialize()
      if (
        (this.logRawCommunication ? this.debug(`>>> ${a}`) : this.debug(`>>> ${r}`),
