...
Каждая строка содержит три поля: дату/время публикации (`dd.MM.yyyy HH:mm`), заголовок новости (`News.title`) и активную ссылку на страницу новости или песни (`News.link`).
