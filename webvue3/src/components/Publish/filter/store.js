...
export default {
  ...
  getters: {
    getPublishFilterDateFrom(state) {
      return state.publishFilterDateFrom
    },
    getPublishFilterDateTo(state) {
      return state.publishFilterDateTo
    },
    getPublishFilterDays(state) {
      return state.publishFilterDays
    },
  },
  mutations: {
  ...
  actions: {
    setPublishFilterDateFrom(ctx, payload) {
      ctx.commit('setPublishFilterDateFrom', payload.value)
    },
    setPublishFilterDateTo(ctx, payload) {
      ctx.commit('setPublishFilterDateTo', payload.value)
    },
    setPublishFilterDays(ctx, payload) {
      ctx.commit('setPublishFilterDays', payload.value)
    },
  },
}
