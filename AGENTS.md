...
При старте каждой сессии обязательно читать также `CLAUDE.md` — он содержит дополнительные указания и архитектурные детали. Оба файла являются руководством к действию.
