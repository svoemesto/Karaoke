<template>
  <transition name="modal-fade">
    <div class="fem-modal-backdrop">
      <div class="fem-area">
        <div class="fem-area-modal-header">File Explorer</div>
                ...
                >
                  ...
                  <template #cell(name)="data">
                    <div
                      ...
                      :style="{
                        backgroundColor: data.item.directory ? 'lightyellow' : 'white',
                        color: fileExplorerCurrentPath === data.item.path ? 'blue' : 'black',
                      }"
                      v-text="data.value"
                    />
                  </template>
  ...
  methods: {
    ...
    getFiles(path) {
      ...
      let request = {
        method: 'POST',
        url: '/api/files',
        params: { path: path, extensions: this.extensions },
      }
      this.isBusy = true
