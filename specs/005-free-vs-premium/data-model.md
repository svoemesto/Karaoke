...
11 записей — финальный список после верификации (см. `research.md` Decision 1,
`spec.md` FR-003); строки 8-9 добавлены 2026-07-31 вслед за реальным
premium-гейтом скорости/тональности в `KaraokePlayer.js`:
...
8. Смена скорости воспроизведения в плеере — `false` / `true`
9. Смена тональности (транспонирование) в плеере — `false` / `true`
10. Создание минусовок (Demucs) — `false` / `true`
11. Чат с автором проекта — `false` / `true`
