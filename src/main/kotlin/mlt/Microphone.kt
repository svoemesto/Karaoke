...
fun getMltMicrophoneProducer(param: Map<String, Any?>, type:ProducerType = ProducerType.MICROPHONE, voiceId: Int = 0): MltNode {
...
fun getMltMicrophoneFilePlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.MICROPHONE, voiceId: Int = 0): MltNode {
...
fun getMltMicrophoneTrackPlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.MICROPHONE, voiceId: Int = 0): MltNode {
...
fun getMltMicrophoneTractor(param: Map<String, Any?>, type:ProducerType = ProducerType.MICROPHONE, voiceId: Int = 0): MltNode {
