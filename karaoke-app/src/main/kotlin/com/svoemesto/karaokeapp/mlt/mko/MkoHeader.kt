...
data class MkoHeader(
    ...
    override fun template(): MltNode {
        ...
        while (songnameW > maxSongnameW) {
            songnameNameMltFont.font =
                Font(
                    songnameNameMltFont.font.name,
                    songnameNameMltFont.font.style,
                    songnameNameMltFont.font.size - 1,
                )
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${(frameWidthPx * 0.6385).toLong()}"), Pair("y", "36")),
                                body =
                                    mutableListOf(
                                        MltNode(
                                            name = "transform",
                                            body = "${frameWidthPx * 0.00025},0,0,0,${frameWidthPx * 0.00025},0,0,0,1",
                                        ),
                                    ),
                            ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${(frameWidthPx * 0.8927).toLong()}"), Pair("y", "36")),
                                body =
                                    mutableListOf(
                                        MltNode(
                                            name = "transform",
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "$offsetX"), Pair("y", "${songnameY.toLong()}")),
                            body =
                                mutableListOf(
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "${authorX.toLong()}"), Pair("y", "${authorY.toLong()}")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "${valueX.toLong()}"), Pair("y", "${authorY.toLong()}")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "${albumX.toLong()}"), Pair("y", "${albumY.toLong()}")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "${valueX.toLong()}"), Pair("y", "${albumY.toLong()}")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${toneX.toLong()}"), Pair("y", "${toneY.toLong()}")),
                                body =
                                    mutableListOf(
                                        MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                    ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${valueX.toLong()}"), Pair("y", "${toneY.toLong()}")),
                                body =
                                    mutableListOf(
                                        MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                    ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${bpmX.toLong()}"), Pair("y", "${bpmY.toLong()}")),
                                body =
                                    mutableListOf(
                                        MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                    ),
                ...
                MltNode(
                    ...
                    body =
                        mutableListOf(
                            MltNode(
                                name = "position",
                                fields = mutableMapOf(Pair("x", "${valueX.toLong()}"), Pair("y", "${bpmY.toLong()}")),
                                body =
                                    mutableListOf(
                                        MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                    ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "0"), Pair("y", "0")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
            ...
            MltNode(
                ...
                body =
                    mutableListOf(
                        MltNode(
                            name = "position",
                            fields = mutableMapOf(Pair("x", "0"), Pair("y", "${246 + 100}")),
                            body =
                                mutableListOf(
                                    MltNode(name = "transform", body = "1,0,0,0,1,0,0,0,1"),
                                ),
