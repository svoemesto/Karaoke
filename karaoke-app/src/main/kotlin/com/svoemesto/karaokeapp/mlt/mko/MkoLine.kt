...
data class MkoLine(
    ...
    private var folderIdLines = mltProp.getId(listOf(ProducerType.LINE, voiceId))
        ...
        val subTrackNodes =
            listOf(
                MltNode(
                    ...
                    fields =
                        mutableMapOf(
                            "producer" to MltGenerator.nameTractor(ProducerType.ELEMENT, voiceId, lineId, 0),
                        ),
                ),
            )
                    ...
                    MltNodeBuilder()
                        ...
                        .node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.LINE, voiceId, lineId),
                                    ),
                            ),
                        ).nodes(subTrackNodes)
