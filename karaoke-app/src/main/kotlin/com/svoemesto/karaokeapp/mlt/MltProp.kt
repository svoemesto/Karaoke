...
data class MltProp(
    ...
    enum class KEYS {
        ...
        IGNORE_CAPO,
        TIMECODE,
        WIDTH_PX_PER_MS_COEFF,
        SCROLL_LINES,
        COUNT_CHILDS,
        HEIGHT_SCROLLER_PX,
        SCROLL_TRACK,
        TIME_TO_SCROLL_SCREEN_MS,
        DURATION_ON_SCREEN,
        FONT_SIZE,
        SONG_TONE,
        SONG_BPM,
...
//    fun setHeightScrollerPx(value: Long) {props[KEYS.ROOT.convertToList(KEYS.HEIGHT_SCROLLER_PX)] = value}
    ...
    fun setDurationOnScreen(
        value: Long,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.DURATION_ON_SCREEN)] = value
    }
    ...
    fun setCountChilds(
        ...
        props[key.convertToList(KEYS.COUNT_CHILDS)] = value
    }
...
//    fun setLengthTimecode(value: String, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.LENGTH_TIMECODE)] = value}
    ...
    fun setUUID(
        ...
        props[key.convertToList(KEYS.UUID)] = value
    }
    ...
    fun setFileName(
        ...
        props[key.convertToList(KEYS.FILE_NAME)] = value
    }
    ...
    fun setVolume(
        ...
        props[key.convertToList(KEYS.VOLUME)] = value
    }
...
//    fun getEnabled(key: Any = KEYS.ROOT): Boolean = props[key.convertToList(KEYS.ENABLED)]?.let { it as Boolean } ?: false
    fun setEnabled(
        ...
        props[key.convertToList(KEYS.ENABLED)] = value
    }

    fun getInOffsetVideo(key: Any = KEYS.ROOT): String = props[key.convertToList(KEYS.IN_OFFSET_VIDEO)]?.let { it as String } ?: ""

    fun setInOffsetVideo(
        value: String,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.IN_OFFSET_VIDEO)] = value
    }
...
//    fun setBoostyLengthFr(value: Long) {props["Boosty".convertToList(KEYS.LENGTH_FR)] = value}
    ...
    fun setBackgroundLengthFr(value: Long) {
        props["Background".convertToList(KEYS.LENGTH_FR)] = value
    }

//    fun getTotalLengthFr(): Long = props["Total".convertToList(KEYS.LENGTH_FR)]?.let { it as Long } ?: 0
    fun setTotalLengthFr(value: Long) {
        props["Total".convertToList(KEYS.LENGTH_FR)] = value
    }

    fun getSongLengthFr(): Long = props["Song".convertToList(KEYS.LENGTH_FR)]?.let { it as Long } ?: 0

    fun setSongLengthFr(value: Long) {
        props["Song".convertToList(KEYS.LENGTH_FR)] = value
    }

    fun getAudioLengthFr(): Long = props["Audio".convertToList(KEYS.LENGTH_FR)]?.let { it as Long } ?: 0

    fun setAudioLengthFr(value: Long) {
        props["Audio".convertToList(KEYS.LENGTH_FR)] = value
    }
...
//    fun setLengthFr(value: Long, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.LENGTH_FR)] = value}
    ...
    fun setBoostyLengthMs(value: Long) {
        props["Boosty".convertToList(KEYS.LENGTH_MS)] = value
    }

    fun getSplashLengthMs(): Long = props["Splash".convertToList(KEYS.LENGTH_MS)]?.let { it as Long } ?: 0

    fun setSplashLengthMs(value: Long) {
        props["Splash".convertToList(KEYS.LENGTH_MS)] = value
    }
...
//    fun setFadeLengthMs(value: Long) {props["Fade".convertToList(KEYS.LENGTH_MS)] = value}
    ...
    fun setLengthMs(
        ...
        props[key.convertToList(KEYS.LENGTH_MS)] = value
    }
...
//    fun setVoiceEndTimecode(value: String) {props["VoiceEnd".convertToList(KEYS.TIMECODE)] = value}
    ...
    fun setSongFadeInTimecode(value: String) {
        props["SongFadeIn".convertToList(KEYS.TIMECODE)] = value
    }

    fun getSongFadeOutTimecode(): String = props["SongFadeOut".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setSongFadeOutTimecode(value: String) {
        props["SongFadeOut".convertToList(KEYS.TIMECODE)] = value
    }

    fun getTotalFadeInTimecode(): String = props["TotalFadeIn".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setTotalFadeInTimecode(value: String) {
        props["TotalFadeIn".convertToList(KEYS.TIMECODE)] = value
    }

    fun getTotalFadeOutTimecode(): String = props["TotalFadeOut".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setTotalFadeOutTimecode(value: String) {
        props["TotalFadeOut".convertToList(KEYS.TIMECODE)] = value
    }

    fun getBoostyFadeInTimecode(): String = props["BoostyFadeIn".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setBoostyFadeInTimecode(value: String) {
        props["BoostyFadeIn".convertToList(KEYS.TIMECODE)] = value
    }

    fun getBoostyFadeOutTimecode(): String = props["BoostyFadeOut".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setBoostyFadeOutTimecode(value: String) {
        props["BoostyFadeOut".convertToList(KEYS.TIMECODE)] = value
    }

    fun getSplashFadeInTimecode(): String = props["SplashFadeIn".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setSplashFadeInTimecode(value: String) {
        props["SplashFadeIn".convertToList(KEYS.TIMECODE)] = value
    }

    fun getSplashFadeOutTimecode(): String = props["SplashFadeOut".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setSplashFadeOutTimecode(value: String) {
        props["SplashFadeOut".convertToList(KEYS.TIMECODE)] = value
    }
...
//    fun setVoiceFadeOutTimecode(value: String) {props["VoiceFadeOut".convertToList(KEYS.TIMECODE)] = value}
    ...
    fun setBoostyBlankTimecode(value: String) {
        props["BoostyBlank".convertToList(KEYS.TIMECODE)] = value
    }

    fun getVoiceBlankTimecode(): String = props["VoiceBlank".convertToList(KEYS.TIMECODE)]?.let { it as String } ?: ""

    fun setVoiceBlankTimecode(value: String) {
        props["VoiceBlank".convertToList(KEYS.TIMECODE)] = value
    }
...
//    fun setStartTimecode(value: String, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.START_TIMECODE)] = value}
    ...
    fun setRootFolder(
        ...
        props[key.convertToList(KEYS.ROOT_FOLDER)] = value
    }

    fun getSongVersion(key: Any = KEYS.ROOT): SongVersion =
        props[key.convertToList(KEYS.SONG_VERSION)]?.let { it as SongVersion } ?: SongVersion.LYRICS

    fun setSongVersion(
        value: SongVersion,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.SONG_VERSION)] = value
    }

    fun getStartSilentOffsetMs(key: Any = KEYS.ROOT): Long = props[key.convertToList(KEYS.START_LINE_OFFSET_MS)]?.let { it as Long } ?: 0

    fun setStartSilentOffsetMs(
        value: Long,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.START_LINE_OFFSET_MS)] = value
    }
    ...
    fun setFrameWidthPx(
        ...
        props[key.convertToList(KEYS.FRAME_WIDTH_PX)] = value
    }

    fun getFrameHeightPx(key: Any = KEYS.ROOT): Int = props[key.convertToList(KEYS.FRAME_HEIGHT_PX)]?.let { it as Int } ?: 0

    fun setFrameHeightPx(
        value: Int,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.FRAME_HEIGHT_PX)] = value
    }
    ...
    fun setSongCapo(
        ...
        props[key.convertToList(KEYS.SONG_CAPO)] = value
    }

    fun getSongChordDescription(key: Any = KEYS.ROOT): String =
        props[key.convertToList(KEYS.SONG_CHORD_DESCRIPTION)]?.let { it as String } ?: ""
//    fun setSongChordDescription(value: String, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.SONG_CHORD_DESCRIPTION)] = value}
    ...
    fun setAuthor(
        ...
        props[key.convertToList(KEYS.AUTHOR)] = value
    }
    ...
    fun setTone(
        ...
        props[key.convertToList(KEYS.TONE)] = value
    }
    ...
    fun setAlbum(
        ...
        props[key.convertToList(KEYS.ALBUM)] = value
    }
    ...
    fun setBpm(
        ...
        props[key.convertToList(KEYS.BPM)] = value
    }
    ...
    fun setYear(
        ...
        props[key.convertToList(KEYS.YEAR)] = value
    }
...
//    fun setTrack(value: Long, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.TRACK)] = value}
    ...
    fun setSongBpm(
        ...
        props[key.convertToList(KEYS.SONG_BPM)] = value
    }
    ...
    fun setSongTone(
        ...
        props[key.convertToList(KEYS.SONG_TONE)] = value
    }
    ...
    fun setCountVoices(
        ...
        props[key.convertToList(KEYS.COUNT_VOICES)] = value
    }
...
//    fun setShadow(value: String, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.SHADOW)] = value}
    ...
    fun setPath(
        ...
        props[key.convertToList(KEYS.PATH)] = value
    }
    ...
    fun setBase64(
        ...
        props[key.convertToList(KEYS.BASE64)] = value
    }
...
//    fun setVoicelines(value: MutableList<SongVoiceLine>, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.VOICELINES)] = value}
    ...
    fun setFontSize(
        ...
        props[key.convertToList(KEYS.FONT_SIZE)] = value
    }

    fun getSymbolHeightPx(key: Any = KEYS.ROOT): Int = props[key.convertToList(KEYS.SYMBOL_HEIGHT_PX)]?.let { it as Int } ?: 0

    fun setSymbolHeightPx(
        value: Int,
        key: Any = KEYS.ROOT,
    ) {
        props[key.convertToList(KEYS.SYMBOL_HEIGHT_PX)] = value
    }
    ...
    fun setPositionYPx(
        ...
        props[key.convertToList(KEYS.POSITION_Y_PX)] = value
    }
    ...
    fun setPositionXPx(
        ...
        props[key.convertToList(KEYS.POSITION_X_PX)] = value
    }
...
//    fun setCountFingerboards(value: Int, key: Any = KEYS.ROOT) {props[key.convertToList(KEYS.COUNT_FINGERBOARDS)] = value}
    ...
    fun setId(
        ...
        props[key.convertToList(KEYS.ID)] = value
    }
    ...
    fun setRect(
        ...
        props[key.convertToList(KEYS.RECT)] = value
    }
