...
related:
  ...
  - ../../../docs/invariants.md (legacy drill-down)
---
...
> Migrated из `docs/invariants.md` (Pass 51 follow-up спеки 189).
> Датированная история инцидентов — в [livedocs/architecture-notes.md](../architecture-notes.md).
...
миграция, ручной fix) должен вручную пересчитать `recordhash`. См.
...
- [`../architecture-notes.md`](../architecture-notes.md) — dated-история
- [`../../CONTRIBUTING.md`](../../CONTRIBUTING.md) — правила оформления кода
- [`../../archive/docs/features/dual-db-sync.md`](../../archive/docs/features/dual-db-sync.md) — sync-механизм (legacy)

## История

- Создан: 2026-07-21 (PR #24)
- Migrated: 2026-08-14 (Pass 51 follow-up спеки 189) — `docs/invariants.md` → `livedocs/architecture/invariants.md`