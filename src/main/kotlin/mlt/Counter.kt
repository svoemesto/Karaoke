...
fun getMltCounterProducer(param: Map<String, Any?>, id: Long, type:ProducerType = ProducerType.COUNTER, voiceId: Int = 0): MltNode {
    ...
    val mlt = MltNode(
        ...
        body = mutableListOf(
            ...
            MltNode(name = "property", fields = mutableMapOf(Pair("name","xmldata")), body = param["${type.text.uppercase()}${voiceId}${id}_XML_DATA"]),
            ...
            MltNode(name = "property", fields = mutableMapOf(Pair("name","kdenlive:id")), body = (param["${type.text.uppercase()}${voiceId}${id}_ID"] as Int)+voiceId*100),
...
fun getMltCounterFilePlaylist(param: Map<String, Any?>, id: Long, type:ProducerType = ProducerType.COUNTER, voiceId: Int = 0): MltNode {
...
fun getMltCounterTrackPlaylist(param: Map<String, Any?>, id: Long, type:ProducerType = ProducerType.COUNTER, voiceId: Int = 0): MltNode {
...
fun getMltCounterTractor(param: Map<String, Any?>, id: Long, type:ProducerType = ProducerType.COUNTER, voiceId: Int = 0): MltNode {
