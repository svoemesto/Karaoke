                ...
                body =
                    MltNodeBuilder()
                        ...
                        .node(
                            MltNode(
                                name = "track",
                                fields = mutableMapOf("producer" to MltGenerator.nameProducerBlackTrack(type, voiceId)),
                            ),
                        ).nodes(
                                ...
                                for (childI in 0 until countChilds) {
                                    result.add(
                                        MltNode(
                                            ...
                                            fields =
                                                mutableMapOf(
                                                    "producer" to MltGenerator.nameTractor(ProducerType.SCROLLERTRACK, voiceId, childI),
                                                ),
                                        ),
                                    )
                                }
