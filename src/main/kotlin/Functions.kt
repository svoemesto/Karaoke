...
fun createKaraoke(song: Song) {
    ...
    param["SONG_TEXT_WORK_AREA_HEIGHT_PX"] = workAreaHeightPx
    param["SONG_TEXT_XML_DATA"] = templateSongText
    ...
    param["SONG_TEXT_ID"] = idProducerSongText
    ...
    param["AUDIO_SONG_ID"] = idProducerAudioSong
    param["AUDIO_MUSIC_ID"] = idProducerAudioMusic
    param["AUDIO_VOCAL_ID"] = idProducerAudioVocal
    ...
    param["FILL_EVEN_PROPERTY_RECT"] = propFillEvenValue
    param["FILL_ODD_PROPERTY_RECT"] = propFillOddValue
    param["SONG_TEXT_PROPERTY_RECT"] = propRectValue
    param["LOGOTYPE_PATH"] = kdeLogoPath
    param["MICROPHONE_PATH"] = kdeMicrophonePath
    param["AUDIO_SONG_PATH"] = song.settings.audioSongFileName
    ...
    param["HIDE_TRACTOR_FILL_EVEN"] = "audio"
    param["HIDE_TRACTOR_FILL_ODD"] = "audio"
    param["HIDE_TRACTOR_SONG_TEXT"] = "audio"
