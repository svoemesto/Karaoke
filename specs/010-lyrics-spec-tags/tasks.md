...
- [X] T024 [US3] Ручная проверка в браузере по `quickstart.md` Сценариям D и E — формализована и расширена в `specs/016-fix-spec-tags-marker-loss-on-reopen/quickstart.md` (сценарии A-G, включая reopen-регрессию, не покрытую исходной quickstart-010). T024 закрыта этим PR (#015).
