...
enum class ProducerType(
    ...
    FILLCOLORSONGTEXT(
        parent = FILLCOLORSONGTEXTS,
        level = 4,
        isCalculatedCount = false,
        text = "fillcolorsongtext",
        onlyOne = false,
        ids = mutableListOf(0, 1),
        isAudio = false,
        isVideo = true,
        coeffStatic = 0,
        coeffVoice = 2,
    ...
    CHORDPICTURELINETRACK(
        parent = CHORDPICTURELINES,
        level = 6,
        isCalculatedCount = true,
        text = "chordpicturelinetrack",
        onlyOne = false,
        ids = mutableListOf(),
        isAudio = false,
        isVideo = true,
    ...
    CHORDPICTURELINE(
        parent = CHORDPICTURELINETRACK,
        level = 7,
        isCalculatedCount = true,
        text = "chordpictureline",
        onlyOne = false,
        ids = mutableListOf(),
        isAudio = false,
        isVideo = true,
    ...
    CHORDPICTUREELEMENT(
        parent = CHORDPICTURELINE,
        level = 8,
        isCalculatedCount = true,
        text = "chordpictureelement",
        onlyOne = false,
        ids = mutableListOf(),
        isAudio = false,
        isVideo = true,
    ...
    CHORDPICTUREIMAGE(
        parent = CHORDPICTUREELEMENT,
        level = 9,
        isCalculatedCount = true,
        text = "chordpictureimage",
        onlyOne = false,
        ids = mutableListOf(),
        isAudio = false,
        isVideo = true,
