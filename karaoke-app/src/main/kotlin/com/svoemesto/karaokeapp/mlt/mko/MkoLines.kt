...
data class MkoLines(
    ...
    override fun tractorSequence(): MltNode {
        ...
        val subTrackNodes =
            (0 until countLineTracks).map { trackI ->
                MltNode(
                    name = "track",
                    fields =
                        mutableMapOf(
                            "producer" to MltGenerator.nameTractor(ProducerType.LINETRACK, voiceId, trackI),
                        ),
                )
            }
                    ...
                    MltNodeBuilder()
                        ...
                        .node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.LINES, voiceId),
                                    ),
                            ),
                        ).nodes(subTrackNodes)
