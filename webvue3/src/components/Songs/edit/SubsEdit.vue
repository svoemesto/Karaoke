          ...
          <div class="se-grid-item-header">
            ...
            <div class="se-tabs">
              ...
              <select id="select-tabs" v-model="indexTabsVariant" style="width: 100px">
                <option
                  v-for="value in lstIndexesTabsVariant"
                  :key="value.value"
                  :value="value.value"
                  :label="value.text"
                />
            ...
            <div class="se-sound">
              ...
              <button
                ...
                :class="soundButtonClass('voice')"
                type="button"
                value="voice"
                @click="setSound('voice')"
              >
                Голос
              </button>
              <button
                class="se-group-button"
                :class="soundButtonClass('song')"
                type="button"
                value="song"
                @click="setSound('song')"
              >
              ...
              <button
                class="se-group-button"
                :class="soundButtonClass('minus')"
                type="button"
                value="minus"
                @click="setSound('minus')"
              >
                Минус
              </button>
              <button
                class="se-group-button"
                :class="soundButtonClass('drums')"
                type="button"
                value="minus"
                @click="setSound('drums')"
              >
                Ударные
              </button>
              <button
                class="se-group-button"
                :class="soundButtonClass('bass')"
                type="button"
                value="minus"
                @click="setSound('bass')"
              >
            ...
            <div class="se-markers">
              <button
                class="se-group-button"
                :value="isShowMarkerTypeSyllables"
                :class="merkerButtonClass(isShowMarkerTypeSyllables)"
                type="button"
                @click="onOffShowMarkerType('syllables')"
              >
                syll
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeSetting"
                :class="merkerButtonClass(isShowMarkerTypeSetting)"
                type="button"
                @click="onOffShowMarkerType('setting')"
              >
                sett
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEndofline"
                :class="merkerButtonClass(isShowMarkerTypeEndofline)"
                type="button"
                @click="onOffShowMarkerType('endofline')"
              >
                eol
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEndofsyllable"
                :class="merkerButtonClass(isShowMarkerTypeEndofsyllable)"
                type="button"
                @click="onOffShowMarkerType('endofsyllable')"
              >
                eos
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeNewline"
                :class="merkerButtonClass(isShowMarkerTypeNewline)"
                type="button"
                @click="onOffShowMarkerType('newline')"
              >
                nl
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeUnmute"
                :class="merkerButtonClass(isShowMarkerTypeUnmute)"
                type="button"
                @click="onOffShowMarkerType('unmute')"
              >
                unmute
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeNote"
                :class="merkerButtonClass(isShowMarkerTypeNote)"
                type="button"
                @click="onOffShowMarkerType('note')"
              >
                note
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeChord"
                :class="merkerButtonClass(isShowMarkerTypeChord)"
                type="button"
                @click="onOffShowMarkerType('chord')"
              >
                chord
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeBeat"
                :class="merkerButtonClass(isShowMarkerTypeBeat)"
                type="button"
                @click="onOffShowMarkerType('beat')"
              >
                beat
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEOLCH"
                :class="merkerButtonClass(isShowMarkerTypeEOLCH)"
                type="button"
                @click="onOffShowMarkerType('eolch')"
              >
                eolch
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEOCH"
                :class="merkerButtonClass(isShowMarkerTypeEOCH)"
                type="button"
                @click="onOffShowMarkerType('eoch')"
              >
                eoch
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeNLCH"
                :class="merkerButtonClass(isShowMarkerTypeNLCH)"
                type="button"
                @click="onOffShowMarkerType('nlch')"
              >
                nlch
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEOLN"
                :class="merkerButtonClass(isShowMarkerTypeEOLN)"
                type="button"
                @click="onOffShowMarkerType('eoln')"
              >
                eoln
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeEON"
                :class="merkerButtonClass(isShowMarkerTypeEON)"
                type="button"
                @click="onOffShowMarkerType('eon')"
              >
                eon
              </button>
              <button
                class="se-group-button"
                :value="isShowMarkerTypeNLN"
                :class="merkerButtonClass(isShowMarkerTypeNLN)"
                type="button"
                @click="onOffShowMarkerType('nln')"
              >
                nln
              </button>
            </div>
          ...
          <div class="se-grid-item-waveform">
            <div class="se-item-left-waveform">
              <div class="se-item-left-label-and-input">
                ...
                <input
                  v-model="currentMarker.markertype"
                  class="se-item-left-input-field"
              ...
              <div class="se-item-left-label-and-input">
                ...
                <input
                  v-model="currentMarker.stringLad"
                  class="se-item-left-input-field"
                  @focus="setEditMode(false)"
                  @blur="setEditMode(true)"
                />
          ...
          <div class="se-grid-item-controls">
            <div class="se-group-controls-region-buttons">
              <button
                ...
                class="se-group-button"
                type="button"
                @click="setRegionMode(!isRegionMode)"
              >
                <img
                  alt="Выключить регион"
                  class="se-icon-40"
                  title="Выключить регион"
                  src="../../../assets/svg/icon_region_mode_on.svg"
                />
              </button>
              <button
                v-else
              ...
              >
                <img
                  alt="Включить регион"
                  class="se-icon-40"
                  title="Включить регион"
                  src="../../../assets/svg/icon_region_mode_off.svg"
                />
              </button>
              <button
                v-if="isMoveMode"
                class="se-group-button"
                type="button"
                :disabled="!isRegionMode"
                @click="setMoveMode(!isMoveMode)"
              >
                <img
                  alt="Выключить режим сдвига маркеров"
                  class="se-icon-40"
                  title="Выключить режим сдвига маркеров"
                  src="../../../assets/svg/icon_markers_in_region_move_on.svg"
                />
              </button>
              <button
                v-else
              ...
              >
                <img
                  alt="Включить режим сдвига маркеров"
                  class="se-icon-40"
                  title="Включить режим сдвига маркеров"
                  src="../../../assets/svg/icon_markers_in_region_move_off.svg"
                />
              </button>
              <button
                class="se-group-button"
                type="button"
                :disabled="!isRegionMode"
                @click="pasteMarkersInRegionToNewPlace"
              >
                <img
                  alt="Вставить маркеры из региона в новое место"
                  class="se-icon-40"
                  title="Вставить маркеры из региона в новое место"
              ...
              <button
                ...
                type="button"
                :disabled="!isRegionMode"
                @click="deleteMarkersInRegion"
              >
                <img
                  alt="далить маркеры из региона"
                  class="se-icon-40"
                  title="Удалить маркеры из региона"
                  src="../../../assets/svg/icon_markers_in_region_delete.svg"
                />
              </button>
            </div>
            <div class="se-group-edit-play-speed-buttons">
              <div class="se-group-edit-speed-buttons">
                ...
                <button
                  class="se-group-button"
                  :class="editSpeedButtonClass(0.3)"
                  type="button"
                  value="0.3"
                  @click="setEditSpeed(0.3)"
                >
                  0.3
                </button>
                <button
                  class="se-group-button"
                  :class="editSpeedButtonClass(0.4)"
                  type="button"
                  value="0.4"
                  @click="setEditSpeed(0.4)"
                >
                  0.4
                </button>
                <button
                  class="se-group-button"
                  :class="editSpeedButtonClass(0.5)"
                  type="button"
                  value="0.5"
                  @click="setEditSpeed(0.5)"
                >
                  0.5
                </button>
                <button
                  class="se-group-button"
                  :class="editSpeedButtonClass(0.75)"
                  type="button"
                  value="0.75"
                  @click="setEditSpeed(0.75)"
                >
                  0.75
                </button>
                <button
                  class="se-group-button"
                  :class="editSpeedButtonClass(1.0)"
                  type="button"
                  value="1.0"
                  @click="setEditSpeed(1.0)"
                >
                  1.0
                </button>
                ...
                <button
                  class="se-group-button"
                  :class="editModeTypeButtonClass('syllables')"
                  type="button"
                  value="syllables"
                  @click="setEditModeType('syllables')"
                >
                  syll
                </button>
                <button
                  class="se-group-button"
                  :class="editModeTypeButtonClass('note')"
                  type="button"
                  value="note"
                  @click="setEditModeType('note')"
                >
                  note
                </button>
                <button
                  class="se-group-button"
                  :class="editModeTypeButtonClass('chord')"
                  type="button"
                  value="chord"
                  @click="setEditModeType('chord')"
                >
                  syll
                </button>
              </div>
              <div class="se-group-play-speed-buttons">
                ...
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(0.5)"
                  type="button"
                  value="0.5"
                  @click="setPlaySpeed(0.5)"
                >
                  0.5
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(0.75)"
                  type="button"
                  value="0.75"
                  @click="setPlaySpeed(0.75)"
                >
                  0.75
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(1.0)"
                  type="button"
                  value="1.0"
                  @click="setPlaySpeed(1.0)"
                >
                  1.0
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(1.25)"
                  type="button"
                  value="1.25"
                  @click="setPlaySpeed(1.25)"
                >
                  1.25
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(1.5)"
                  type="button"
                  value="1.5"
                  @click="setPlaySpeed(1.5)"
                >
                  1.5
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(1.75)"
                  type="button"
                  value="1.75"
                  @click="setPlaySpeed(1.75)"
                >
                  1.75
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(2.0)"
                  type="button"
                  value="2.0"
                  @click="setPlaySpeed(2.0)"
                >
                  2.0
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(2.25)"
                  type="button"
                  value="2.25"
                  @click="setPlaySpeed(2.25)"
                >
                  2.25
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(2.5)"
                  type="button"
                  value="2.5"
                  @click="setPlaySpeed(2.5)"
                >
                  2.5
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(2.75)"
                  type="button"
                  value="2.75"
                  @click="setPlaySpeed(2.75)"
                >
                  2.75
                </button>
                <button
                  class="se-group-button"
                  :class="playSpeedButtonClass(3.0)"
                  type="button"
                  value="3.0"
                  @click="setPlaySpeed(3.0)"
                >
                  3.0
                </button>
              </div>
            ...
            <div class="se-group-controls-markers-buttons">
              <div class="se-group-control-buttons">
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedBL)"
                  @mousedown.left="pressedBL = true"
                  @mouseup.left="pressedBL = false"
                >
                  <img
                    alt="previous marker"
                    class="se-icon-previous-marker"
                    title="["
                    src="../../../assets/svg/icon_previous_marker.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedZ)"
                  @mousedown.left="pressedZ = true"
                  @mouseup.left="pressedZ = false"
                >
                  <img
                    alt="fast-fast backward"
                    class="se-icon-fast-fast-backward"
                    title="Z"
                    src="../../../assets/svg/icon_fast_fast_backward.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedA)"
                  @mousedown.left="pressedA = true"
                  @mouseup.left="pressedA = false"
                >
                  <img
                    alt="fast backward"
                    class="se-icon-fast-backward"
                    title="A"
                ...
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedQ)"
                  @mousedown.left="pressedQ = true"
                  @mouseup.left="pressedQ = false"
                >
                  <img
                    alt="step backward"
                    class="se-icon-step-backward"
                    title="Q"
                    src="../../../assets/svg/icon_step_backward.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="playPauseButtonClass(isPlaying)"
                  title="X"
                  @click="playPause"
                >
                  <img
                    alt="play-pause"
                    class="se-icon-play-pause"
                    src="../../../assets/svg/icon_play_pause.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedE)"
                  @mousedown.left="pressedE = true"
                  @mouseup.left="pressedE = false"
                >
                  <img
                    alt="step forward"
                    class="se-icon-step-forward"
                    title="E"
                    src="../../../assets/svg/icon_step_forward.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedD)"
                  @mousedown.left="pressedD = true"
                  @mouseup.left="pressedD = false"
                >
                  <img
                    alt="fast forward"
                    class="se-icon-fast-forward"
                    title="D"
                ...
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedC)"
                  @mousedown.left="pressedC = true"
                  @mouseup.left="pressedC = false"
                >
                  <img
                    alt="fast-fast forward"
                    class="se-icon-fast-fast-forward"
                    title="C"
                    src="../../../assets/svg/icon_fast_fast_forward.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedBR)"
                  @mousedown.left="pressedBR = true"
                  @mouseup.left="pressedBR = false"
                >
                  <img
                    alt="next marker"
                    class="se-icon-next-marker"
                    title="]"
                    src="../../../assets/svg/icon_next_marker.svg"
                  />
                </button>
              </div>
              <div class="se-group-markers-buttons">
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedW)"
                  @mousedown.left="pressedW = true"
                  @mouseup.left="pressedW = false"
                >
                  <img
                    alt="add marker"
                    class="se-icon-add-marker"
                    title="W"
                    src="../../../assets/svg/icon_add_marker_orange.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedS)"
                  @mousedown.left="pressedS = true"
                  @mouseup.left="pressedS = false"
                >
                  <img
                    alt="delete marker"
                    class="se-icon-delete-marker"
                    title="S"
                    src="../../../assets/svg/icon_delete_marker.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressed1)"
                  @mousedown.left="pressed1 = true"
                  @mouseup.left="pressed1 = false"
                >
                  <img
                    alt="end of line marker"
                    class="se-icon-end-of-line-marker"
                    title="1"
                    src="../../../assets/svg/icon_add_marker_red.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressed2)"
                  @mousedown.left="pressed2 = true"
                  @mouseup.left="pressed2 = false"
                >
                  <img
                    alt="end of line marker"
                    class="se-icon-end-of-line-marker"
                ...
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressed3)"
                  @mousedown.left="pressed3 = true"
                  @mouseup.left="pressed3 = false"
                >
                  <img
                    alt="end of line and add marker"
                    class="se-icon-end-of-line-and-add-marker"
                    title="3"
                    src="../../../assets/svg/icon_add_marker_red_orange.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressed4)"
                  @mousedown.left="pressed4 = true"
                  @mouseup.left="pressed4 = false"
                >
                  <img
                    alt="new line marker"
                    class="se-icon-new-line-marker"
                    title="4"
                    src="../../../assets/svg/icon_add_marker_magenta.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressed0)"
                  @mousedown.left="pressed0 = true"
                  @mouseup.left="pressed0 = false"
                >
                  <img
                    alt="mute marker"
                    class="se-icon-mute-marker"
                    title="0"
                    src="../../../assets/svg/icon_add_marker_yellow.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedT)"
                  @mousedown.left="pressedT = true"
                  @mouseup.left="pressedT = false"
                >
                  <img
                    alt="group 0 marker"
                    class="se-icon-group0-marker"
                    title="T"
                    src="../../../assets/svg/icon_add_marker_blue_white.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedY)"
                  @mousedown.left="pressedY = true"
                  @mouseup.left="pressedY = false"
                >
                  <img
                    alt="group 1 marker"
                    class="se-icon-group1-marker"
                    title="Y"
                    src="../../../assets/svg/icon_add_marker_yellow_white.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedU)"
                  @mousedown.left="pressedU = true"
                  @mouseup.left="pressedU = false"
                >
                  <img
                    alt="group 2 marker"
                    class="se-icon-group2-marker"
                    title="U"
                    src="../../../assets/svg/icon_add_marker_aqua_white.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedI)"
                  @mousedown.left="pressedI = true"
                  @mouseup.left="pressedI = false"
                >
                  <img
                    alt="group 3 marker"
                    class="se-icon-group3-marker"
                    title="I"
                    src="../../../assets/svg/icon_add_marker_green_white.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedP)"
                  @mousedown.left="pressedP = true"
                  @mouseup.left="pressedP = false"
                >
                  <img
                    alt="group 4 marker"
                    class="se-icon-group4-marker"
                    title="P"
                    src="../../../assets/svg/icon_add_marker_gray_white.svg"
                  />
                </button>
                <button
                  class="se-group-button"
                  :class="pressedButtonClass(pressedO)"
                  @mousedown.left="pressedO = true"
                  @mouseup.left="pressedO = false"
                >
                  <img
                    alt="comment marker"
                    class="se-icon-comment-marker"
                    title="O"
                    src="../../../assets/svg/icon_add_marker_magenta_white.svg"
                  />
                </button>
              </div>
            </div>
            <div class="se-group-actions-buttons">
              <button class="se-group-button" type="button" @click="doMarkersDec">
                <img
                  alt="diffbeatsdec"
                  class="se-icon-40"
                  title="Сдвинуть маркеры влево"
                  src="../../../assets/svg/icon_move_markers_left.svg"
                />
              </button>
              <button class="se-group-button" type="button" @click="doMarkersFirst">
                <img
                  alt="diffbeatsdec"
                  class="se-icon-40"
                  title="Сдвинуть сюда первый маркер"
                  src="../../../assets/svg/icon_move_markers_left_right.svg"
                />
              </button>
              <button class="se-group-button" type="button" @click="doMarkersInc">
                <img
                  alt="diffbeatsinc"
                  class="se-icon-40"
                  title="Сдвинуть маркеры вправо"
                  src="../../../assets/svg/icon_move_markers_right.svg"
                />
              </button>
              <button class="se-group-button" type="button" @click="doSearchText">
                <img
                  alt="search text"
                  class="se-icon-40"
                  title="Найти в Интернете текст песни"
              ...
              <button class="se-group-button" type="button" @click="addAccent">
                <img
                  alt="erase markers"
                  class="se-icon-40"
                  title="Добавить ударение"
                  src="../../../assets/svg/icon_accent.svg"
                />
              </button>
              ...
              <button class="se-group-button" type="button" @click="doReplaceText">
                <img
                  alt="replace text"
                  class="se-icon-40"
                  title="Произвести замену текста согласно правилам"
                  src="../../../assets/svg/icon_replace_text.svg"
                />
              </button>
...
export default {
  ...
  computed: {
    ...
    markerTypesToShow() {
      let result = []
      if (this.isShowMarkerTypeSyllables) {
        result.push('syllables')
      }
      if (this.isShowMarkerTypeSetting) {
        result.push('setting')
      }
      if (this.isShowMarkerTypeEndofline) {
        result.push('endofline')
      }
      if (this.isShowMarkerTypeEndofsyllable) {
        result.push('endofsyllable')
      }
      if (this.isShowMarkerTypeNewline) {
        result.push('newline')
      }
      if (this.isShowMarkerTypeUnmute) {
        result.push('unmute')
      }
      if (this.isShowMarkerTypeNote) {
        result.push('note')
      }
      if (this.isShowMarkerTypeChord) {
        result.push('chord')
      }
      if (this.isShowMarkerTypeBeat) {
        result.push('beat')
      }
      if (this.isShowMarkerTypeEOLN) {
        result.push('eoln')
      }
      if (this.isShowMarkerTypeEON) {
        result.push('eon')
      }
      if (this.isShowMarkerTypeNLN) {
        result.push('nln')
      }
      if (this.isShowMarkerTypeEOLCH) {
        result.push('eolch')
      }
      if (this.isShowMarkerTypeEOCH) {
        result.push('eoch')
      }
      if (this.isShowMarkerTypeNLCH) {
        result.push('nlch')
      }
      return result
    },
      ...
      for (let i = 0; i < markers.length; i++) {
        ...
        switch (marker.markertype) {
          ...
          case 'syllables': {
            ...
            lineNotes +=
              (i === this.currentMarkersIndex ? SPAN_STYLE_CURRENT : SPAN_STYLE_NOTE) +
              noteHtml +
              SPAN_END +
              SPAN_STYLE_OCTAVE +
              noteOctave +
              SPAN_END
            lineText +=
              (i === this.currentMarkersIndex ? SPAN_STYLE_CURRENT : SPAN_STYLE_TEXT) +
              txtHtml +
              SPAN_END
            if (!endOfWord) {
      ...
      for (let i = 0; i < markers.length; i++) {
        ...
        switch (marker.markertype) {
          case 'setting': {
            switch (marker.label) {
              case 'GROUP|0': {
                spanStyle = SPAN_STYLE_GROUP0
                break
              }
              case 'GROUP|1': {
                spanStyle = SPAN_STYLE_GROUP1
                break
              }
              case 'GROUP|2': {
                spanStyle = SPAN_STYLE_GROUP2
                break
              }
              case 'GROUP|3': {
                spanStyle = SPAN_STYLE_GROUP3
                break
              }
              case 'COMMENT| ': {
                result += '<br>'
          ...
          default: {
            break
          } // unmute, note, chord, eolch, eoch, nlch, eoln, eon, nln...
        }
    ...
    getTail() {
      ...
      let textBegin = ''
      let textCurr =
        this.currentSyllablesIndex === this.sourceSyllables.length - 1 &&
        this.currentSyllablesIndex >= 0
          ? this.sourceSyllables[this.sourceSyllables.length - 1].replaceAll('_', ' ')
          : ''
      let textNext = ''
      let textEnd = ''
  ...
  watch: {
    ...
    pressedA: {
      handler() {
        ...
        if (this.pressedA) {
          ...
          this.intervalSkipBackward = setInterval(() => {
            this.ws.skip(-this.editSpeed * 0.01)
          }, 10)
        } else {
    ...
    pressedZ: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedZ) {
          this.intervalPressZ = setInterval(() => {
            this.ws.skip(-0.1)
          }, 50)
        } else {
    ...
    pressedC: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedC) {
          this.intervalPressC = setInterval(() => {
            this.ws.skip(0.1)
          }, 50)
        } else {
    ...
    pressedT: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedT) {
          this.addMarker('setting', 'GROUP|0')
        }
      },
    },
    pressedY: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedY) {
          this.addMarker('setting', 'GROUP|1')
        }
      },
    },
    pressedU: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedU) {
          this.addMarker('setting', 'GROUP|2')
        }
      },
    },
    pressedI: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedI) {
          this.addMarker('setting', 'GROUP|3')
        }
      },
    },
    pressedP: {
      handler() {
        if (!this.isEditMode) return
        if (this.pressedP) {
          this.addMarker('setting', 'GROUP|4')
        }
      },
    },
    pressedO: {
    ...
    pressedBL: {
      handler() {
        ...
        if (this.pressedBL) {
          ...
          this.intervalPressBL = setInterval(() => {
            this.goToPreviousMarker()
          }, 100)
        } else {
    ...
    pressedBR: {
      handler() {
        ...
        if (this.pressedBR) {
          this.goToNextMarker()
          this.intervalPressBR = setInterval(() => {
            this.goToNextMarker()
          }, 100)
        } else {
        ...
        if (this.pressedComma) {
          switch (this.editModeType) {
            case 'syllables':
              ...
              this.intervalPressComma = setInterval(() => {
                this.goToPreviousMarker('syllables')
              }, 100)
              break
            case 'note':
        ...
        if (this.pressedPeriod) {
          switch (this.editModeType) {
            case 'syllables':
              ...
              this.intervalPressPeriod = setInterval(() => {
                this.goToNextMarker('syllables')
              }, 100)
              break
            case 'note':
  ...
  async mounted() {
    ...
    this.wsRegions.on('region-updated', (region) => {
      ...
      if (this.isRegionMode && this.isMoveMode && region.id === this.regionMarker.region.id) {
        if (
          regionMarkerStart !== this.regionMarkerStart &&
          regionMarkerEnd !== this.regionMarkerEnd
        ) {
          let markersToMove = this.sourceMarkers
            .filter(
              (marker) =>
                marker.time >= this.regionMarkerStart && marker.time <= this.regionMarkerEnd,
            )
            .sort(function (a, b) {
  ...
  methods: {
    ...
    addEndMarker() {
      ...
      const endMarker = this.sourceMarkers.find(
        (marker) => marker.markertype === 'setting' && marker.label === 'END',
      )
      if (!endMarker) {
        let newEndMarker = {
          time: duration,
    ...
    listenerKeyDown(e) {
      switch (e.code) {
        ...
        case 'Comma': {
          if (!this.pressedComma) {
            this.pressedComma = true
          }
          break
        }
        case 'Period': {
          if (!this.pressedPeriod) {
            this.pressedPeriod = true
          }
          break
        }
        case 'KeyW': {
    ...
    listenerKeyUp(e) {
      switch (e.code) {
        ...
        case 'BracketLeft': {
          if (this.pressedBL) {
            this.pressedBL = false
          }
          break
        }
        case 'BracketRight': {
          if (this.pressedBR) {
            this.pressedBR = false
          }
          break
        }
        case 'Comma': {
          if (this.pressedComma) {
            this.pressedComma = false
          }
          break
        }
        case 'Period': {
          if (this.pressedPeriod) {
            this.pressedPeriod = false
          }
          break
        }
        case 'KeyW': {
    ...
    //
    // Вызывается СТРОГО после того, как `sourceMarkers` заполнен из `loadedMarkers` (в `mounted()`
    // или в `currentVoice` watcher'е). На первом открытии голоса это гарантируется порядком
    ...
    addMarker(markerType, settingValue = '', notDelete = false, withEndOfLine = false) {
      ...
      let timeToAdd = this.currentTime
      let currentMarkerTime =
        this.currentMarkersIndex >= 0 ? this.sourceMarkers[this.currentMarkersIndex].time : 0
      ...
      if (needCalcBpm) {
        ...
        let bpmMarkers = this.sourceMarkers.filter(
          (marker) =>
            marker.markertype === 'setting' &&
            marker.label.startsWith('BPM|') &&
    ...
    deleteMarker() {
      ...
      if (diff < 0.002) {
        if (
          this.currentMarkersIndex > 0 &&
          Math.abs(this.sourceMarkers[this.currentMarkersIndex - 1].time - currentMarker.time) <
            0.002
        ) {
    ...
    createBeatMarkers() {
      ...
      let countBeatMarkers = this.sourceMarkers.filter(
        (marker) => marker.markertype === 'beat',
      ).length
      while (countBeatMarkers !== 0) {
        ...
        countBeatMarkers = this.sourceMarkers.filter(
          (marker) => marker.markertype === 'beat',
        ).length
      }
      ...
      let bpmMarkers = this.sourceMarkers.filter(
        (marker) => marker.markertype === 'setting' && marker.label.startsWith('BPM|'),
      )
    ...
    async doChordsAdd() {
      ...
      for (let i = 0; i < chords.length; i++) {
        ...
        if (chordName !== 'S') {
          strChords =
            strChords.substring(0, chordBeatIndex) +
            chordName +
            strChords.substring(Number(chordBeatIndex) + Number(chordName.length))
          let newMarker = {
            time: chordDuration,
            label: chordName,
      ...
      let markers = this.sourceMarkers.filter(
        (item) => item.markertype === 'syllables' && item.label,
      )
      for (let markerIndex = 0; markerIndex < markers.length; markerIndex++) {
        ...
        let text = marker.label.replaceAll('_', ' ').trim()
        strBeats =
          strBeats.substring(0, markerBeattimeIndex) +
          text +
          strBeats.substring(Number(markerBeattimeIndex) + Number(text.length))
      }
      while (strChords.length > 0) {
        ...
        result +=
          SPAN_STYLE_TEXT +
          lineBeats
            .replaceAll(BEAT_SYMBOL_MOD1, '&nbsp;')
            .replaceAll(BEAT_SYMBOL_MOD4, '&nbsp;')
            .replaceAll(BEAT_SYMBOL_MOD16, '&nbsp;') +
          SPAN_END +
          BR +
          BR
      }
    ...
    doChordsDel() {
      ...
      let countChordsMarkers = this.sourceMarkers.filter(
        (marker) => marker.markertype === 'chord',
      ).length
      while (countChordsMarkers !== 0) {
        ...
        countChordsMarkers = this.sourceMarkers.filter(
          (marker) => marker.markertype === 'chord',
        ).length
      }
    },
    ...
    doReplaceBrokenMarkers() {
      for (let i = 0; i < this.sourceMarkers.length; i++) {
        ...
        if (
          marker.region &&
          marker.markertype === 'setting' &&
          marker.label.startsWith('COMMENT| ')
        ) {
    ...
    doEraseMarkers() {
      ...
      let countBeatMarkers = this.sourceMarkers.filter((marker) =>
        this.isShowMarkerType(marker.markertype),
      ).length
      while (countBeatMarkers !== 0) {
        for (let i = 0; i < this.sourceMarkers.length; i++) {
          let marker = this.sourceMarkers[i]
        ...
        countBeatMarkers = this.sourceMarkers.filter((marker) =>
          this.isShowMarkerType(marker.markertype),
        ).length
      }
    ...
    onOffShowMarkerType(markerType) {
      switch (markerType) {
        case 'syllables': {
          this.isShowMarkerTypeSyllables = !this.isShowMarkerTypeSyllables
          break
        }
        case 'setting': {
          this.isShowMarkerTypeSetting = !this.isShowMarkerTypeSetting
          break
        }
        case 'newline': {
          this.isShowMarkerTypeNewline = !this.isShowMarkerTypeNewline
          break
        }
        case 'endofline': {
          this.isShowMarkerTypeEndofline = !this.isShowMarkerTypeEndofline
          break
        }
        case 'endofsyllable': {
          this.isShowMarkerTypeEndofsyllable = !this.isShowMarkerTypeEndofsyllable
          break
        }
        case 'unmute': {
          this.isShowMarkerTypeUnmute = !this.isShowMarkerTypeUnmute
          break
        }
        case 'note': {
          this.isShowMarkerTypeNote = !this.isShowMarkerTypeNote
          break
        }
        case 'chord': {
          this.isShowMarkerTypeChord = !this.isShowMarkerTypeChord
          break
        }
        case 'beat': {
          this.isShowMarkerTypeBeat = !this.isShowMarkerTypeBeat
          break
        }
        case 'eolch': {
          this.isShowMarkerTypeEOLCH = !this.isShowMarkerTypeEOLCH
          break
        }
        case 'eoch': {
          this.isShowMarkerTypeEOCH = !this.isShowMarkerTypeEOCH
          break
        }
        case 'nlch': {
          this.isShowMarkerTypeNLCH = !this.isShowMarkerTypeNLCH
          break
        }
        case 'eoln': {
          this.isShowMarkerTypeEOLN = !this.isShowMarkerTypeEOLN
          break
        }
        case 'eon': {
          this.isShowMarkerTypeEON = !this.isShowMarkerTypeEON
          break
        }
        case 'nln': {
          this.isShowMarkerTypeNLN = !this.isShowMarkerTypeNLN
          break
        }
      }
    },
                ...
                switch (this.editModeType) {
                  case 'syllables':
                    if (this.currentMarker.markertype === 'syllables') {
                      ...
                      this.currentMarker.region.setContent(
                        this.getRegionContentFromMarker(this.currentMarker),
                      )
                      this.sourceMarkers.splice(0, 1, this.sourceMarkers[0])
                      this.goToNextMarker('syllables')
                    }
    ...
    getStringsForAllNotesInSong() {
      ...
      for (let startLad = 0; startLad < 20; startLad++) {
        ...
        for (let markerIndex = 0; markerIndex < markersList.length; markerIndex++) {
          ...
          const stringsForNote = notesAndStringsArray.filter(
            (item) => item[0] === marker.note,
          )[0][1] // массив пар струна-лад
          let tmpArray = stringsForNote
            .filter((item) => item[1] >= startLad)
            .map((item) => [Math.abs(item[1] - startLad), item])
