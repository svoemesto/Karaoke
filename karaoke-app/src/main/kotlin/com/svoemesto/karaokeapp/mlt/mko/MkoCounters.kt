...
data class MkoCounters(
    ...
    private val mkoCountersUUID = mltProp.getUUID(listOf(type, voiceId))
            ...
            .tractor(
                ...
                body =
                    MltNodeBuilder()
                        ...
                        .propertyName("kdenlive:uuid", "{$mkoCountersUUID}")
                        ...
                        .node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.COUNTERS, voiceId),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.COUNTER, voiceId, 4),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.COUNTER, voiceId, 3),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.COUNTER, voiceId, 2),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.COUNTER, voiceId, 1),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.COUNTER, voiceId, 0),
                                    ),
                            ),
