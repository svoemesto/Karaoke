...
export default {
  ...
  getters: {
    ...
    getSongsHistoryIsLoading(state) {
      return state.songsHistoryIsLoading
    },
    getSongsFilterId(state) {
      return state.songsFilterId
    },
    getSongsFilterSongName(state) {
      return state.songsFilterSongName
    },
    getSongsFilterSongAuthor(state) {
      return state.songsFilterSongAuthor
    },
    getSongsFilterSongAlbum(state) {
      return state.songsFilterSongAlbum
    },
    getSongsFilterPublishDate(state) {
      return state.songsFilterPublishDate
    },
    getSongsFilterPublishTime(state) {
      return state.songsFilterPublishTime
    },
    getSongsFilterIdStatus(state) {
      return state.songsFilterIdStatus
    },
    getSongsFilterCountVoices(state) {
      return state.songsFilterCountVoices
    },
    getSongsFilterTags(state) {
      return state.songsFilterTags
    },
    getSongsFilterResultVersion(state) {
      return state.songsFilterResultVersion
    },
    getSongsFilterVersionBoosty(state) {
      return state.songsFilterVersionBoosty
    },
    getSongsFilterVersionBoostyFiles(state) {
      return state.songsFilterVersionBoostyFiles
    },
    getSongsFilterVersionSponsr(state) {
      return state.songsFilterVersionSponsr
    },
    getSongsFilterVersionDzenKaraoke(state) {
      return state.songsFilterVersionDzenKaraoke
    },
    getSongsFilterVersionVkKaraoke(state) {
      return state.songsFilterVersionVkKaraoke
    },
    getSongsFilterVersionTelegramKaraoke(state) {
      return state.songsFilterVersionTelegramKaraoke
    },
    getSongsFilterVersionPlKaraoke(state) {
      return state.songsFilterVersionPlKaraoke
    },
    getSongsFilterVersionMaxKaraoke(state) {
      return state.songsFilterVersionMaxKaraoke
    },
    getSongsFilterRate(state) {
      return state.songsFilterRate
    },
    getSongsFilterIsSync(state) {
      return state.songsFilterIsSync
    },
    getSongsFilterStatusProcessLyrics(state) {
      return state.songsFilterStatusProcessLyrics
    },
    getSongsFilterStatusProcessKaraoke(state) {
      return state.songsFilterStatusProcessKaraoke
    },
    getSongsFilterStatusProcessDemo(state) {
      return state.songsFilterStatusProcessDemo
    },
    ...
    getSongsFilterFlagFree(state) {
      return state.songsFilterFlagFree
    },
    getSongsFilterAssignmentStatus(state) {
      return state.songsFilterAssignmentStatus
    },
  ...
  mutations: {
    ...
    setSongsHistoryIsLoading(state, isLoading) {
      state.songsHistoryIsLoading = isLoading
    },
    ...
    setSongsFilterVersionTelegramKaraoke(state, value) {
      setWebvueProp(
        state.songsFilterVersionTelegramKaraoke,
        'songsFilterVersionTelegramKaraoke',
        value,
      )
    ...
    setSongsFilterSongType(state, value) {
      setWebvueProp(state.songsFilterSongType, 'songsFilterSongType', value)
      state.songsFilterSongType = value
    },
  },
  actions: {
    ...
    setSongsFilterId(ctx, payload) {
      ctx.commit('setSongsFilterId', payload.value)
    },
    setSongsFilterSongName(ctx, payload) {
      ctx.commit('setSongsFilterSongName', payload.value)
    },
    setSongsFilterSongAuthor(ctx, payload) {
      ctx.commit('setSongsFilterSongAuthor', payload.value)
    },
    setSongsFilterSongAlbum(ctx, payload) {
      ctx.commit('setSongsFilterSongAlbum', payload.value)
    },
    setSongsFilterPublishDate(ctx, payload) {
      ctx.commit('setSongsFilterPublishDate', payload.value)
    },
    setSongsFilterPublishTime(ctx, payload) {
      ctx.commit('setSongsFilterPublishTime', payload.value)
    },
    setSongsFilterIdStatus(ctx, payload) {
      ctx.commit('setSongsFilterIdStatus', payload.value)
    },
    setSongsFilterCountVoices(ctx, payload) {
      ctx.commit('setSongsFilterCountVoices', payload.value)
    },
    setSongsFilterTags(ctx, payload) {
      ctx.commit('setSongsFilterTags', payload.value)
    },
    setSongsFilterResultVersion(ctx, payload) {
      ctx.commit('setSongsFilterResultVersion', payload.value)
    },
    setSongsFilterVersionBoosty(ctx, payload) {
      ctx.commit('setSongsFilterVersionBoosty', payload.value)
    },
    setSongsFilterVersionBoostyFiles(ctx, payload) {
      ctx.commit('setSongsFilterVersionBoostyFiles', payload.value)
    },
    setSongsFilterVersionSponsr(ctx, payload) {
      ctx.commit('setSongsFilterVersionSponsr', payload.value)
    },
    setSongsFilterVersionDzenKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterVersionDzenKaraoke', payload.value)
    },
    setSongsFilterVersionVkKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterVersionVkKaraoke', payload.value)
    },
    setSongsFilterVersionTelegramKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterVersionTelegramKaraoke', payload.value)
    },
    setSongsFilterVersionPlKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterVersionPlKaraoke', payload.value)
    },
    setSongsFilterVersionMaxKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterVersionMaxKaraoke', payload.value)
    },
    setSongsFilterRate(ctx, payload) {
      ctx.commit('setSongsFilterRate', payload.value)
    },
    setSongsFilterIsSync(ctx, payload) {
      ctx.commit('setSongsFilterIsSync', payload.value)
    },
    setSongsFilterStatusProcessLyrics(ctx, payload) {
      ctx.commit('setSongsFilterStatusProcessLyrics', payload.value)
    },
    setSongsFilterStatusProcessKaraoke(ctx, payload) {
      ctx.commit('setSongsFilterStatusProcessKaraoke', payload.value)
    },
    setSongsFilterStatusProcessDemo(ctx, payload) {
      ctx.commit('setSongsFilterStatusProcessDemo', payload.value)
    },
    ...
    setSongsFilterFlagFree(ctx, payload) {
      ctx.commit('setSongsFilterFlagFree', payload.value)
    },
    setSongsFilterAssignmentStatus(ctx, payload) {
      ctx.commit('setSongsFilterAssignmentStatus', payload.value)
    },
    setSongsFilterSongType(ctx, payload) {
      ctx.commit('setSongsFilterSongType', payload.value)
    },
  },
}
