<template>
    <div class="sut-table">
        ...
        <div class="sut-toolbar">
            ...
            <button
                class="sut-toolbar-item sut-btn"
            ...
            <button class="sut-toolbar-item sut-btn" @click="reload">
                Обновить
            </button>
        </div>
