...
export default {
    ...
    getters: {
        getSiteUsersFilterId(state) { return state.siteUsersFilterId },
        getSiteUsersFilterEmail(state) { return state.siteUsersFilterEmail },
        getSiteUsersFilterDisplayName(state) { return state.siteUsersFilterDisplayName },
        getSiteUsersFilterSponsrUid(state) { return state.siteUsersFilterSponsrUid },
        getSiteUsersFilterIsPremium(state) { return state.siteUsersFilterIsPremium },
        getSiteUsersFilterIsPermanentPremium(state) { return state.siteUsersFilterIsPermanentPremium },
        getSiteUsersFilterIsEffectivePremium(state) { return state.siteUsersFilterIsEffectivePremium },
        getSiteUsersFilterIsEditor(state) { return state.siteUsersFilterIsEditor },
        getSiteUsersFilterIsBanned(state) { return state.siteUsersFilterIsBanned },
    },
    mutations: {
        ...
        setSiteUsersFilterIsPermanentPremium(state, value) {
            setWebvueProp(state.siteUsersFilterIsPermanentPremium, 'siteUsersFilterIsPermanentPremium', value);
            state.siteUsersFilterIsPermanentPremium = value;
        },
        setSiteUsersFilterIsEffectivePremium(state, value) {
            setWebvueProp(state.siteUsersFilterIsEffectivePremium, 'siteUsersFilterIsEffectivePremium', value);
    ...
    actions: {
        setSiteUsersFilterId(ctx, payload) { ctx.commit('setSiteUsersFilterId', payload.value) },
        setSiteUsersFilterEmail(ctx, payload) { ctx.commit('setSiteUsersFilterEmail', payload.value) },
        setSiteUsersFilterDisplayName(ctx, payload) { ctx.commit('setSiteUsersFilterDisplayName', payload.value) },
        setSiteUsersFilterSponsrUid(ctx, payload) { ctx.commit('setSiteUsersFilterSponsrUid', payload.value) },
        setSiteUsersFilterIsPremium(ctx, payload) { ctx.commit('setSiteUsersFilterIsPremium', payload.value) },
        setSiteUsersFilterIsPermanentPremium(ctx, payload) { ctx.commit('setSiteUsersFilterIsPermanentPremium', payload.value) },
        setSiteUsersFilterIsEffectivePremium(ctx, payload) { ctx.commit('setSiteUsersFilterIsEffectivePremium', payload.value) },
        setSiteUsersFilterIsEditor(ctx, payload) { ctx.commit('setSiteUsersFilterIsEditor', payload.value) },
        setSiteUsersFilterIsBanned(ctx, payload) { ctx.commit('setSiteUsersFilterIsBanned', payload.value) },
