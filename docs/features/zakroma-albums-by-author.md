...
- [specs/356-zakroma-albums-by-author/research.md](../../specs/356-zakroma-albums-by-author/research.md) — решение «year+name» и раздел R9, где ADR по сортировке был запланирован (сам ADR `local-0007-album-tile-sort-order` так и не создан).
