...
data class MltProp(
    ...
    enum class KEYS {ROOT, SETTINGS, FRAME_WIDTH_PX, FRAME_HEIGHT_PX, START_LINE_OFFSET_MS, SONG_VERSION, ID, VOICE_SETTING, RECT, SONG_CAPO, SONG_CHORD_DESCRIPTION, SONG_NAME,
        COUNT_VOICES, COUNT_AUDIO_TRACKS, COUNT_ALL_TRACKS, WORK_AREA_HEIGHT_PX, VOICELINES,
        SYMBOL_HEIGHT_PX, POSITION_Y_PX, POSITION_X_PX, UUID, AUTHOR, TONE, BPM, ALBUM, YEAR, TRACK,
        PATH, BASE64, FINGERBOARD_H, CHORDS, ROOT_FOLDER,
        LENGTH_MS, LENGTH_FR,
        IN_OFFSET_VIDEO, ENABLED, VOLUME, FILE_NAME, IGNORE_CAPO, TIMECODE, WIDTH_PX_PER_MS_COEFF, SCROLL_LINES,
        COUNT_CHILDS, HEIGHT_SCROLLER_PX, SCROLL_TRACK,
        TIME_TO_SCROLL_SCREEN_MS, DURATION_ON_SCREEN, FONT_SIZE, SONG_TONE, SONG_BPM
