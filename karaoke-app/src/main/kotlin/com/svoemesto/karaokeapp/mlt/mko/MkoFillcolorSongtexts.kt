                    ...
                    MltNodeBuilder()
                        ...
                        .node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.FILLCOLORSONGTEXTS, voiceId),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.FILLCOLORSONGTEXT, voiceId, 0),
                                    ),
                            ),
                        ).node(
                            MltNode(
                                ...
                                fields =
                                    mutableMapOf(
                                        "producer" to MltGenerator.nameTractor(ProducerType.FILLCOLORSONGTEXT, voiceId, 1),
                                    ),
                            ),
