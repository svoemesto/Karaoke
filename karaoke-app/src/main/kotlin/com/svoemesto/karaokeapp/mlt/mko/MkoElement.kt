...
//                timecodeIn = mltProp.getTimelineStartTimecode(),
    ...
    override fun tractorSequence(): MltNode {
        ...
        val subTrackNodes =
            ProducerType.ELEMENT.childs().asReversed().filter { it in songVersion.producers }.map {
...
//                .propertyName("kdenlive:sequenceproperties.tracksCount", 2)
                    ...
                    .node(
                        MltNode(
                            ...
                            fields =
                                mutableMapOf(
                                    "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.ELEMENT, voiceId, lineId, elementId),
                                ),
                        ),
                    ).nodes(subTrackNodes)
