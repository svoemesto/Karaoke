...
//    private val settings = mltProp.getSettings()
                ...
                mltGenerator.entry(
                    ...
                    nodes =
                        MltNodeBuilder()
                            ...
                            .filterQtblend(
                                "filter_qtblend_${listOf(ProducerType.CHORDPICTUREELEMENT.name, voiceId, lineId).hashCode()}",
                                mainFilePlaylistTransformProperties(),
                            ).build(),
                ),
            )
        }
    ...
    override fun tractorSequence(): MltNode {
        ...
        val subTrackNodes =
            ProducerType.CHORDPICTUREELEMENT.childs().asReversed().filter { it in songVersion.producers }.map {
                ...
                MltNodeBuilder()
                    ...
                    .node(
                        MltNode(
                            ...
                            fields =
                                mutableMapOf(
                                    "producer" to MltGenerator.nameProducerBlackTrack(ProducerType.CHORDPICTUREELEMENT, voiceId, lineId),
                                ),
                        ),
                    ).nodes(subTrackNodes)
