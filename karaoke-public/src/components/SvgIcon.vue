<template>
  ...
  >
    ...
    <template v-if="name === 'sponsr' && active">
      ...
      <path
        d="M1.33782 15C3.06687 17.989 6.29859 20 10 20C13.7014 20 16.9331 17.989 18.6622 15H1.33782Z"
        fill="#B2125C"
      />
    </template>
    ...
    <template v-else-if="name === 'dzen' && active">
      ...
      <path
        fill="#fff"
        fill-rule="evenodd"
        d="M11.64 0c-.06 4.865-.392 7.599-2.217 9.423C7.6 11.248 4.865 11.58 0 11.64v.72c4.865.06 7.599.392 9.423 2.217C11.248 16.4 11.58 19.135 11.64 24h.72c.06-4.865.392-7.599 2.217-9.423C16.4 12.752 19.135 12.42 24 12.36v-.72c-4.865-.06-7.599-.392-9.423-2.217C12.752 7.6 12.42 4.865 12.36 0h-.72Z"
        clip-rule="evenodd"
      />
    </template>
    ...
    <template v-else-if="name === 'boosty' && active">
      <path
        fill="#F57507"
        d="M2.52164 11.9462L5.9255 0H11.1491L10.0928 3.70385C10.0817 3.72498 10.0726 3.74714 10.0658 3.77L7.29168 13.55H9.88032C8.80005 16.2923 7.95391 18.4423 7.34268 20C2.56645 19.9462 1.22732 16.4738 2.39955 12.3662L2.52164 11.9462ZM7.36046 20L13.6574 10.8H10.9853L13.3097 4.90692C17.2985 5.33 19.1693 8.51462 18.0697 12.3654C16.889 16.5077 12.1104 20 7.45782 20H7.36046Z"
      />
    </template>
    ...
    <template v-else-if="name === 'premium' && active">
      ...
      <path
        d="M10 6 L10.94 8.71 L13.8 8.76 L11.52 10.49 L12.35 13.24 L10 11.6 L7.65 13.24 L8.48 10.49 L6.2 8.76 L9.06 8.71 Z"
        fill="#B5730A"
      />
    </template>
    ...
    <template v-else-if="name === 'pl' && active">
      ...
      <path
        d="M140.364 53.9091V147H118.182V71.9091H83.6363V147H61.4545V53.9091H140.364Z"
        fill="white"
      />
    </template>
    ...
    <template v-else-if="name === 'favorite'">
      <path
        d="M6 2.8h8a.8.8 0 0 1 .8.8v13.9l-4.8-3.45L5.2 17.5V3.6a.8.8 0 0 1 .8-.8z"
        fill="none"
        stroke="#E11D2A"
        stroke-width="1.4"
      />
