...
object WhisperMarkerAligner {
    ...
    private fun rebuildText(
        ...
        targetWords.forEachIndexed { wordIndex, word ->
            ...
            // только последний - заменяем ВСЕ "_" на пробел (как и делает Song.getText() для
    ...
    private fun buildTargetWords(
        ...
        lines.forEachIndexed { lineIndex, line ->
            ...
            // визуальный артефакт, а конвенция, на которой держится Song.getText/getTextFormatted
