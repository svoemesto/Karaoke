...
enum class MusicNote(val text: String, val names: List<String>, val defaultRootFret: Int, val frequencies: List<Double>) {
    ...
    D_SHARP (text = "ре диез", names = listOf("D#", "E♭", "D♯", "Eb"), defaultRootFret = 6, frequencies = listOf(19.45, 38.89, 77.78, 155.6, 311.1, 622.3, 1245.0, 2489.0, 4978.0)),
    E (text = "ми", names = listOf("E", "F♭", "Fb"), defaultRootFret = 0, frequencies = listOf(20.6, 41.2, 82.41, 164.8, 329.6, 659.3, 1319.0, 2637.0, 5274.0)),
    F (text = "фа", names = listOf("F", "E#", "E♯"), defaultRootFret = 1, frequencies = listOf(21.83, 43.65, 87.31, 174.6, 349.2, 698.5, 1397.0, 2794.0, 5588.0)),
