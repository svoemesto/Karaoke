...
exports.install = function (opts, server) {
  ...
  sjs_echo.installHandlers(server, { prefix: '/echo', response_limit: 4096 })
  sjs_echo.installHandlers(server, { prefix: '/disabled_websocket_echo', websocket: false })
  sjs_echo.installHandlers(server, { prefix: '/cookie_needed_echo', jsessionid: true })
