...
export default {
  ...
  getters: {
    getPropertiesFilterKey(state) {
      return state.propertiesFilterKey
    },
    getPropertiesFilterValue(state) {
      return state.propertiesFilterValue
    },
    getPropertiesFilterDefaultValue(state) {
      return state.propertiesFilterDefaultValue
    },
    getPropertiesFilterDescription(state) {
      return state.propertiesFilterDescription
    },
  ...
  actions: {
    setPropertiesFilterKey(ctx, payload) {
      ctx.commit('setPropertiesFilterKey', payload.value)
    },
    setPropertiesFilterValue(ctx, payload) {
      ctx.commit('setPropertiesFilterValue', payload.value)
    },
    setPropertiesFilterDefaultValue(ctx, payload) {
      ctx.commit('setPropertiesFilterDefaultValue', payload.value)
    },
    setPropertiesFilterDescription(ctx, payload) {
      ctx.commit('setPropertiesFilterDescription', payload.value)
    },
    setPropertiesFilterType(ctx, payload) {
      ctx.commit('setPropertiesFilterType', payload.value)
    },
  },
}
