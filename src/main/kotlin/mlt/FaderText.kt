...
fun getMltFaderTextProducer(param: Map<String, Any?>, type:ProducerType = ProducerType.FADERTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFaderTextFilePlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FADERTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFaderTextTrackPlaylist(param: Map<String, Any?>, type:ProducerType = ProducerType.FADERTEXT, voiceId: Int = 0): MltNode {
...
fun getMltFaderTextTractor(param: Map<String, Any?>, type:ProducerType = ProducerType.FADERTEXT, voiceId: Int = 0): MltNode {
...
fun getTemplateFaderText(param: Map<String, Any?>): MltNode {
