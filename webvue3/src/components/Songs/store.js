...
export default {
  ...
  getters: {
    ...
    getAllSongsIds(state) {
      return state.songPages.length
        ? state.songPages.flatMap((page) => page.flatMap((song) => song.id))
        : []
    },
    getAuthors(state) {
    ...
    // },
    getFirstSong(state) {
      return state.currentSongPageIndex >= 0 &&
        state.songPages.length &&
        state.songPages[state.currentSongPageIndex][0]
        ? state.songPages[state.currentSongPageIndex][0]
        : []
    },
    getLastSong(state) {
      return state.currentSongPageIndex >= 0 && state.songPages.length
        ? state.songPages[state.currentSongPageIndex][-1]
        : []
    },
    ...
    getSongsForUpdateByIds: () => async (ids) => {
      ...
      let params = { ids: ids }
      let request = { method: 'POST', url: '/api/songs/ids', params: params }
    ...
    async dicst() {
      let request = { method: 'POST', url: '/api/songs/dicts' }
    ...
    async getBoostyFilesHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textboostyfileshead',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getDzenKaraokeHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenkaraokeheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenKaraokeBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenkaraokewoheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenLyricsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenlyricsheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenLyricsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenlyricswoheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenChordsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenchordsheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenTabsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzentabsheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenChordsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzenchordswoheader',
        params: { id: state.currentSongId },
      })
    },
    async getDzenTabsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textdzentabswoheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getPlKaraokeHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textplkaraokeheader',
        params: { id: state.currentSongId },
      })
    },
    async getPlKaraokeBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textplkaraokewoheader',
        params: { id: state.currentSongId },
      })
    },
    async getPlLyricsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textpllyricsheader',
        params: { id: state.currentSongId },
      })
    },
    async getPlLyricsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textpllyricswoheader',
        params: { id: state.currentSongId },
      })
    },
    async getPlChordsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textplchordsheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getPlChordsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textplchordswoheader',
        params: { id: state.currentSongId },
      })
    },
    async getPlTabsBody(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textpltabswoheader',
        params: { id: state.currentSongId },
      })
    },
    async getVkKaraokeHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textvkkaraokeheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getVkLyricsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textvklyricsheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getVkChordsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/textvkchordsheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    async getTelegramKaraokeHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/texttelegramkaraokeheader',
        params: { id: state.currentSongId },
      })
    },
    async getTelegramLyricsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/texttelegramlyricsheader',
        params: { id: state.currentSongId },
      })
    },
    async getTelegramChordsHeader(state) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/texttelegramchordsheader',
        params: { id: state.currentSongId },
      })
    },
    ...
    getSourceSyllables: (state) => async (voiceId) => {
      return JSON.parse(
        await promisedXMLHttpRequest({
          method: 'POST',
          url: '/api/song/voicesourcesyllables',
          params: { id: state.currentSongId, voiceId: voiceId },
        }),
      )
    },
    getSourceMarkers: (state) => async (voiceId) => {
      let markers = JSON.parse(
        await promisedXMLHttpRequest({
          method: 'POST',
          url: '/api/song/voicesourcemarkers',
          params: { id: state.currentSongId, voiceId: voiceId },
        }),
      )
    ...
    playKaraoke:
      (state) =>
      async (id = state.currentSongId) => {
        return await promisedXMLHttpRequest({
          method: 'POST',
          url: '/api/song/playkaraoke',
          params: { id: id },
        })
      },
    // TODO перенести в actions
    ...
    getSongsDigestIsLoading(state) {
      return state.songsDigestIsLoading
    },
    ...
    getSearchAsyncList: () => async (songId) => {
      const searchAsyncList = JSON.parse(
        await promisedXMLHttpRequest({
          method: 'POST',
    ...
    getSearchResultsList: () => async (searchAsyncId) => {
      const searchResulstList = JSON.parse(
        await promisedXMLHttpRequest({
          method: 'POST',
  ...
  mutations: {
    setLastSettingType(state, value) {
      if (
        state.lastSettingType !== undefined &&
        state.lastSettingType !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastSettingValue(state, value) {
      if (
        state.lastSettingValue !== undefined &&
        state.lastSettingValue !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorLyrics(state, value) {
      if (
        state.lastPriorLyrics !== undefined &&
        state.lastPriorLyrics !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorKaraoke(state, value) {
      if (
        state.lastPriorKaraoke !== undefined &&
        state.lastPriorKaraoke !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorChords(state, value) {
      if (
        state.lastPriorChords !== undefined &&
        state.lastPriorChords !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorMelody(state, value) {
      if (
        state.lastPriorMelody !== undefined &&
        state.lastPriorMelody !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorDemo(state, value) {
      if (
        state.lastPriorDemo !== undefined &&
        state.lastPriorDemo !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorCodeLyrics(state, value) {
      if (
        state.lastPriorCodeLyrics !== undefined &&
        state.lastPriorCodeLyrics !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorCodeKaraoke(state, value) {
      if (
        state.lastPriorCodeKaraoke !== undefined &&
        state.lastPriorCodeKaraoke !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorDemucs(state, value) {
      if (
        state.lastPriorDemucs !== undefined &&
        state.lastPriorDemucs !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    setLastPriorSmartCopy(state, value) {
      if (
        state.lastPriorSmartCopy !== undefined &&
        state.lastPriorSmartCopy !== null &&
        value !== undefined &&
        value !== null
      ) {
    ...
    async updateSongsAndDictionaries(state, result) {
      ...
      state.currentSong =
        state.songPages && state.songPages.length && state.songPages[0].length
          ? state.songPages[0][0]
          : undefined
      state.currentSongIndex =
        state.songPages && state.songPages.length && state.songPages[0].length ? 0 : undefined
    ...
    async updateSong(state, songFromRest) {
      if (songFromRest) {
        ...
        let songWithIndexesFiltered = state.songPages
          .map(function (page, pageIndex) {
            return page.map(function (song, songIndex) {
        ...
        let songWithIndexes = songWithIndexesFiltered.length
          ? songWithIndexesFiltered[0]
          : undefined
        if (songWithIndexes) {
          ...
          if (id === state.currentSongId) {
            ...
            state.songPages[songWithIndexes.pageIndex].splice(
              songWithIndexes.songIndex,
              1,
              songFromRest,
            )
          }
    ...
    updateSongsByIds(state, songsAndIndexesForUpdate) {
      ...
      for (let songsAndIndexesFromRest of songsAndIndexesForUpdate) {
        if (
          songsAndIndexesFromRest.pageIndex !== undefined &&
          songsAndIndexesFromRest.songIndex !== undefined
        ) {
          state.songPages[songsAndIndexesFromRest.pageIndex].splice(
            songsAndIndexesFromRest.songIndex,
            1,
            songsAndIndexesFromRest.song,
          )
        ...
        for (let i = 0; i < state.publications.length; i++) {
          ...
          if (
            ...
            publication.publish10.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 10
          ...
          if (
            publication.publish11 &&
            publication.publish11.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 11
          ...
          if (
            publication.publish12 &&
            publication.publish12.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 12
          ...
          if (
            publication.publish13 &&
            publication.publish13.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 13
          ...
          if (
            publication.publish14 &&
            publication.publish14.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 14
          ...
          if (
            publication.publish15 &&
            publication.publish15.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 15
          ...
          if (
            publication.publish16 &&
            publication.publish16.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 16
          ...
          if (
            publication.publish17 &&
            publication.publish17.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 17
          ...
          if (
            publication.publish18 &&
            publication.publish18.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 18
          ...
          if (
            publication.publish19 &&
            publication.publish19.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 19
          ...
          if (
            publication.publish20 &&
            publication.publish20.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 20
          ...
          if (
            publication.publish21 &&
            publication.publish21.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 21
          ...
          if (
            publication.publish22 &&
            publication.publish22.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 22
          ...
          if (
            publication.publish23 &&
            publication.publish23.id === songsAndIndexesFromRest.songId
          ) {
            publish = publication
            publishInd = i
            publishFldInd = 23
      ...
      if (oldPageSize !== newPageSize) {
        ...
        while (state.songPages[state.songPages.length - 1].length > newPageSize) {
          ...
          while (state.songPages[state.songPages.length - 2].length > newPageSize) {
            state.songPages[state.songPages.length - 1].unshift(
              state.songPages[state.songPages.length - 2].pop(),
            )
          }
        }
    ...
    setSongsDigestIsLoading(state, isLoading) {
      state.songsDigestIsLoading = isLoading
    },
    ...
    setSearchResultsListIsLoading(state, isLoading) {
      state.searchResultsListIsLoading = isLoading
    },
  },
  actions: {
        ...
        try {
          ...
          if (songFromRest && currId === ctx.state.currentSongId) {
            ...
            if (entryNow) {
              ...
              ctx.commit('setCurrentSongData', {
                song: songFromRest,
                songIndex: entryNow.songIndex,
                pageIndex: entryNow.pageIndex,
              })
            } else {
    ...
    setPreviousAndNextSongId(ctx) {
      ...
      if (currentSongIndex > 0) {
        ...
        if (currentPageIndex > 0) {
          previousSongId =
            ctx.state.pages[currentPageIndex - 1][ctx.state.pages[currentPageIndex - 1].length - 1]
              .id
        }
      }
      if (currentSongIndex < currentPageLength - 1) {
        ...
        if (currentPageIndex < ctx.state.pages.length - 1) {
          nextSongId =
            ctx.state.pages[currentPageIndex + 1][ctx.state.pages[currentPageIndex + 1][0]].id
        }
      }
    ...
    async loadSongsAndDictionaries(ctx, params) {
      ...
      let request = { method: 'POST', url: '/api/songs', params: params }
    ...
    loadSong(ctx, params) {
      let request = { method: 'POST', url: '/api/song', params: params }
      promisedXMLHttpRequest(request)
        .then((data) => {
          let result = JSON.parse(data)
    ...
    async getSheetsageinfoChords(ctx) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/sheetsageinfochords',
        params: { id: ctx.state.currentSongId },
      })
    },
    async getSheetsageinfoBeattimes(ctx) {
      return await promisedXMLHttpRequest({
        method: 'POST',
        url: '/api/song/sheetsageinfobeattimes',
        params: { id: ctx.state.currentSongId },
      })
    },
    ...
    createPictureBoostyTeaserPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpictureboostyteaser', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureSponsrTeaserPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturesponsrteaser', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureBoostyFilesPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpictureboostyfiles', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureVKPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturevk', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureVKlinkPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturevklink', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureKaraokePromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturekaraoke', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureLyricsPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturelyrics', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureChordsPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturechords', params: params }
      return promisedXMLHttpRequest(request)
    },
    createPictureTabsPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createpicturetabs', params: params }
      return promisedXMLHttpRequest(request)
    },
    createDescriptionFileKaraokePromise(ctx) {
      ...
      let request = {
        method: 'POST',
        url: '/api/song/createdescriptionfilekaraoke',
        params: params,
      }
      return promisedXMLHttpRequest(request)
    },
    createDescriptionFileLyricsPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createdescriptionfilelyrics', params: params }
      return promisedXMLHttpRequest(request)
    },
    createDescriptionFileChordsPromise(ctx) {
      let params = { id: ctx.state.currentSongId }
      let request = { method: 'POST', url: '/api/song/createdescriptionfilechords', params: params }
      return promisedXMLHttpRequest(request)
    },
    ...
    copyFieldsFromAnotherPromise(ctx, payload) {
      let params = {
        id: ctx.state.currentSongId,
        idAnother: payload.idAnother,
        fields: payload.fields,
      }
      let request = { method: 'POST', url: '/api/song/copyfieldsfromanother', params: params }
      return promisedXMLHttpRequest(request)
    },
    ...
    createDzenPicturesForFolderPromise(ctx, payload) {
      ...
      let request = {
        method: 'POST',
        url: '/api/utils/createdzenpicturesforfolder',
        params: params,
      }
      return promisedXMLHttpRequest(request)
    },
    ...
    actualizeVKLinkPictureWebPromise() {
      let request = { method: 'POST', url: '/api/utils/actualizevklinkpictureweb' }
      return promisedXMLHttpRequest(request)
    },
    ...
    updateBpmAndKeyLVPromise() {
      let request = { method: 'POST', url: '/api/utils/updatebpmandkeylv' }
      return promisedXMLHttpRequest(request)
    },
    markDublicatesPromise(ctx, payload) {
      let request = {
        method: 'POST',
        url: '/api/utils/markdublicates',
    ...
    clearPreDublicatesPromise() {
      let request = { method: 'POST', url: '/api/utils/clearpredublicates' }
      return promisedXMLHttpRequest(request)
    },
    ...
    async loadUnpublications(ctx) {
      let request = { method: 'POST', url: '/api/unpublications' }
      promisedXMLHttpRequest(request)
        .then((data) => {
          let result = JSON.parse(data)
    ...
    async loadSkipedPublications(ctx) {
      let request = { method: 'POST', url: '/api/skipedpublications' }
      promisedXMLHttpRequest(request)
        .then((data) => {
          let result = JSON.parse(data)
